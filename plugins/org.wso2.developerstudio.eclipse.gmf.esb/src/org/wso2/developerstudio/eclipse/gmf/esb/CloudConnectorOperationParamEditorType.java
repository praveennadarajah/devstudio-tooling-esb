 ...
 * @generated
 */
public enum CloudConnectorOperationParamEditorType implements Enumerator {
    /**
	 ...
	 * @ordered
	 */
    NAMESPACED_PROPERTY_EDITOR(1, "NamespacedPropertyEditor", "NamespacedPropertyEditor");
    ...
    /**
	 * The '<em><b>Namespaced Property Editor</b></em>' literal value.
	 * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Namespaced Property Editor</b></em>' literal object isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
    public static final int NAMESPACED_PROPERTY_EDITOR_VALUE = 1;
	 ...
	 * @generated
	 */
    public static CloudConnectorOperationParamEditorType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CloudConnectorOperationParamEditorType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
    public static CloudConnectorOperationParamEditorType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CloudConnectorOperationParamEditorType result = VALUES_ARRAY[i];
