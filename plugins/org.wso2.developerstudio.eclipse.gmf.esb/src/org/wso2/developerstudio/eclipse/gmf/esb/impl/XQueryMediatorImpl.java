...
public class XQueryMediatorImpl extends MediatorImpl implements XQueryMediator {
    ...
    protected XQueryMediatorImpl() {
        ...
        // Target XPath.
        NamespacedProperty targetXPath = EsbFactoryImpl.eINSTANCE.createNamespacedProperty();
	 ...
	 * @generated
	 */
    public NotificationChain basicSetInputConnector(XQueryMediatorInputConnector newInputConnector,
	 ...
	 * @generated
	 */
    public NotificationChain basicSetOutputConnector(XQueryMediatorOutputConnector newOutputConnector,
            NotificationChain msgs) {
