...
public class RuleMediatorImpl extends MediatorImpl implements RuleMediator {
    ...
    public NotificationChain basicSetChildMediatorsConfiguration(
            RuleChildMediatorsConfiguration newChildMediatorsConfiguration, NotificationChain msgs) {
    ...
    public NotificationChain basicSetChildMediatorsOutputConnector(
            RuleMediatorChildMediatorsOutputConnector newChildMediatorsOutputConnector, NotificationChain msgs) {
    ...
    public void setChildMediatorsOutputConnector(
            RuleMediatorChildMediatorsOutputConnector newChildMediatorsOutputConnector) {
