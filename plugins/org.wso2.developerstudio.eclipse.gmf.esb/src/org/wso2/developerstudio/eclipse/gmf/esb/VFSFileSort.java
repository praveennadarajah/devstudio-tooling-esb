 ...
 * @generated
 */
public enum VFSFileSort implements Enumerator {
    /**
	 ...
	 * @ordered
	 */
    LASTMODIFIEDTIMESTAMP(3, "lastmodifiedtimestamp", "lastmodifiedtimestamp");
    ...
    /**
	 * The '<em><b>Lastmodifiedtimestamp</b></em>' literal value.
	 * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Lastmodifiedtimestamp</b></em>' literal object isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
    public static final int LASTMODIFIEDTIMESTAMP_VALUE = 3;
	 ...
	 * @generated
	 */
    public static VFSFileSort get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			VFSFileSort result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
    public static VFSFileSort getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			VFSFileSort result = VALUES_ARRAY[i];
