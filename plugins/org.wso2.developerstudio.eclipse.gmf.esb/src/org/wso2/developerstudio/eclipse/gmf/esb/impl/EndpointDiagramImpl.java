...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Endpoint Diagram</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class EndpointDiagramImpl extends EsbElementImpl implements EndpointDiagram {
    /**
    ...
    protected EClass eStaticClass() {
		return EsbPackage.Literals.ENDPOINT_DIAGRAM;
	}
    ...
    public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ENDPOINT_DIAGRAM__NAME, oldName, name));
	}
