...
public class InboundEndpointImpl extends EsbElementImpl implements InboundEndpoint {
	 ...
	 * @ordered
	 */
    protected String transportVFSFailedRecordNextRetryDuration = TRANSPORT_VFS_FAILED_RECORD_NEXT_RETRY_DURATION_EDEFAULT;
	 ...
	 * @ordered
	 */
    protected static final String TRANSPORT_VFS_REPLY_FILE_URI_EDEFAULT = null;
	 ...
	 * @ordered
	 */
    protected static final String TRANSPORT_JMSDB_URL_EDEFAULT = "";
    ...
    public NotificationChain basicSetTransportRabbitMqConsumerQosKey(
            RegistryKeyProperty newTransportRabbitMqConsumerQosKey, NotificationChain msgs) {
    ...
    public void setTransportJMSResetConnectionOnPollingSuspension(
            boolean newTransportJMSResetConnectionOnPollingSuspension) {
    ...
    public String getTransportVFSMoveAfterFailedMove() {
		return transportVFSMoveAfterFailedMove;
	}
    ...
    public String getTransportVFSFailedRecordsFileName() {
		return transportVFSFailedRecordsFileName;
	}
    ...
    public String getTransportVFSFailedRecordsFileDestination() {
		return transportVFSFailedRecordsFileDestination;
	}
    ...
    public String getTransportVFSMoveFailedRecordTimestampFormat() {
		return transportVFSMoveFailedRecordTimestampFormat;
	}
    ...
    public String getTransportVFSFailedRecordNextRetryDuration() {
		return transportVFSFailedRecordNextRetryDuration;
	}
    ...
    public String getTransportVFSReplyFileURI() {
		return transportVFSReplyFileURI;
	}
    ...
    public String getTransportVFSReplyFileName() {
		return transportVFSReplyFileName;
	}
    ...
    public String toString() {
		...
		result.append(transportVFSMaxRetryCount);
		result.append(", transportVFSMoveAfterFailedMove: ");
		result.append(transportVFSMoveAfterFailedMove);
		...
		result.append(transportVFSMoveAfterErrors);
		result.append(", transportVFSFailedRecordsFileName: ");
		result.append(transportVFSFailedRecordsFileName);
		result.append(", transportVFSFailedRecordsFileDestination: ");
		result.append(transportVFSFailedRecordsFileDestination);
		result.append(", transportVFSMoveFailedRecordTimestampFormat: ");
		result.append(transportVFSMoveFailedRecordTimestampFormat);
		result.append(", transportVFSFailedRecordNextRetryDuration: ");
		result.append(transportVFSFailedRecordNextRetryDuration);
		result.append(", transportVFSActionAfterFailure: ");
		result.append(transportVFSActionAfterFailure);
		result.append(", transportVFSMoveAfterFailure: ");
		result.append(transportVFSMoveAfterFailure);
		result.append(", transportVFSReplyFileURI: ");
		result.append(transportVFSReplyFileURI);
		result.append(", transportVFSReplyFileName: ");
		result.append(transportVFSReplyFileName);
