 ...
 * @generated
 */
public enum JMSBrokerType implements Enumerator {
    /**
	 ...
	 * @ordered
	 */
    WSO2_BROKER_PROFILE(0, "WSO2_BROKER_PROFILE", "WSO2_BROKER_PROFILE"),
    ...
    /**
	 * The '<em><b>WSO2 BROKER PROFILE</b></em>' literal value.
	 * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>WSO2 BROKER PROFILE</b></em>' literal object isn't clear,
	 ...
	 * @ordered
	 */
    public static final int WSO2_BROKER_PROFILE_VALUE = 0;
	 ...
	 * @generated
	 */
    public static JMSBrokerType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			JMSBrokerType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
    public static JMSBrokerType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			JMSBrokerType result = VALUES_ARRAY[i];
