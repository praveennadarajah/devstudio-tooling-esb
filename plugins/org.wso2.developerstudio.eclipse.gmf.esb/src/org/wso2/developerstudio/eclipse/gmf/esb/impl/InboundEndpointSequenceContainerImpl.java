...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Inbound Endpoint Sequence Container</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.InboundEndpointSequenceContainerImpl#getMediatorFlow <em>Mediator Flow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InboundEndpointSequenceContainerImpl extends EsbNodeImpl implements InboundEndpointSequenceContainer {
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EsbPackage.INBOUND_ENDPOINT_SEQUENCE_CONTAINER__MEDIATOR_FLOW, oldMediatorFlow, newMediatorFlow);
    ...
    public void setMediatorFlow(MediatorFlow newMediatorFlow) {
		if (newMediatorFlow != mediatorFlow) {
			...
			if (mediatorFlow != null)
				msgs = ((InternalEObject)mediatorFlow).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EsbPackage.INBOUND_ENDPOINT_SEQUENCE_CONTAINER__MEDIATOR_FLOW, null, msgs);
			if (newMediatorFlow != null)
				msgs = ((InternalEObject)newMediatorFlow).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EsbPackage.INBOUND_ENDPOINT_SEQUENCE_CONTAINER__MEDIATOR_FLOW, null, msgs);
...
} // InboundEndpointSequenceContainerImpl
