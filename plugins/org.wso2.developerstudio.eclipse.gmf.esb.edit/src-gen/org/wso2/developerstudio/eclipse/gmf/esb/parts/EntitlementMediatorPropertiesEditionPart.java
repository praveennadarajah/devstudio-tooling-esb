...
public interface EntitlementMediatorPropertiesEditionPart {
     ...
     * 
     * @param newValue the new entitlementServerURL to set
     * 
     */
     ...
     * 
     * @param newValue the new callbackHandler to set
     * 
     */
     ...
     * 
     * @param newValue the new callbackClassName to set
     * 
     */
     ...
     * 
     * @param newValue the new thriftHost to set
     * 
     */
     ...
     * 
     * @param newValue the new thriftPort to set
     * 
     */
     ...
     * 
     * @param newValue the new entitlementClientType to set
     * 
     */
     ...
     * 
     * @param newValue the new onRejectSequenceType to set
     * 
     */
     ...
     * 
     * @param newValue the new onAcceptSequenceType to set
     * 
     */
     ...
     * 
     * @param newValue the new adviceSequenceType to set
     * 
     */
     ...
     * 
     * @param newValue the new obligationsSequenceType to set
     * 
     */
    ...
    // Start of user code for onRejectSequenceKey specific getters and setters declaration
