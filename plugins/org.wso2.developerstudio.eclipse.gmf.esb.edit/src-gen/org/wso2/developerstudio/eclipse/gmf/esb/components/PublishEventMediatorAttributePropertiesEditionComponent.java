...
public class PublishEventMediatorAttributePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public PublishEventMediatorAttributePropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject publishEventMediatorAttribute, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeName))
                basePart.setAttributeName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        publishEventMediatorAttribute.getAttributeName()));

            if (isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValueType)) {
                basePart.initAttributeValueType(
                        EEFUtils.choiceOfValues(publishEventMediatorAttribute,
                                EsbPackage.eINSTANCE.getAbstractNameValueExpressionAttribute_AttributeValueType()),
                        publishEventMediatorAttribute.getAttributeValueType());
            }
            if (isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValue))
                basePart.setAttributeValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        publishEventMediatorAttribute.getAttributeValue()));

            if (isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeType)) {
                basePart.initAttributeType(
                        EEFUtils.choiceOfValues(publishEventMediatorAttribute,
                                EsbPackage.eINSTANCE.getAbstractNameValueExpressionAttribute_AttributeType()),
                        publishEventMediatorAttribute.getAttributeType());
            }
            if (isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.defaultValue))
                basePart.setDefaultValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        publishEventMediatorAttribute.getDefaultValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeName == event.getAffectedEditor()) {
            publishEventMediatorAttribute.setAttributeName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValueType == event
                .getAffectedEditor()) {
        ...
        if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValue == event.getAffectedEditor()) {
            publishEventMediatorAttribute.setAttributeValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.defaultValue == event.getAffectedEditor()) {
            publishEventMediatorAttribute.setDefaultValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeExpression == event
                .getAffectedEditor()) {
            ...
            if (event.getNewValue() != null) {
                ...
                publishEventMediatorAttribute
                        .setAttributeExpression(EsbFactoryImpl.eINSTANCE.createNamespacedProperty());
            }
            // End of user code
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionAttribute_AttributeName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeName)) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionAttribute_AttributeValueType()
                    .equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValueType))
                basePart.setAttributeValueType((AttributeValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionAttribute_AttributeValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionAttribute_AttributeType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeType))
                basePart.setAttributeType((AttributeType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPublishEventMediatorAttribute_DefaultValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediatorAttribute.Properties.defaultValue)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeName == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractNameValueExpressionAttribute_AttributeName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractNameValueExpressionAttribute_AttributeName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValueType == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractNameValueExpressionAttribute_AttributeValueType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractNameValueExpressionAttribute_AttributeValueType().getEAttributeType(),
                ...
                if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValue == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractNameValueExpressionAttribute_AttributeValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractNameValueExpressionAttribute_AttributeValue().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeType == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractNameValueExpressionAttribute_AttributeType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractNameValueExpressionAttribute_AttributeType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PublishEventMediatorAttribute.Properties.defaultValue == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getPublishEventMediatorAttribute_DefaultValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPublishEventMediatorAttribute_DefaultValue().getEAttributeType(),
                            newValue);
                }
