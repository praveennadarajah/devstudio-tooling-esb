...
public class PropertyMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public PropertyMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject propertyMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.PropertyMediator.Properties.oM))
                basePart.setOM(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, propertyMediator.getOM()));

            if (isAccessible(EsbViewsRepository.PropertyMediator.Properties.valueStringPattern))
                basePart.setValueStringPattern(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        propertyMediator.getValueStringPattern()));

            if (isAccessible(EsbViewsRepository.PropertyMediator.Properties.valueStringCapturingGroup)) {
                basePart.setValueStringCapturingGroup(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        propertyMediator.getValueStringCapturingGroup()));
            }

            if (isAccessible(EsbViewsRepository.PropertyMediator.Properties.newPropertyName))
                basePart.setNewPropertyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        propertyMediator.getNewPropertyName()));
            ...
            if (isAccessible(EsbViewsRepository.PropertyMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        propertyMediator.getDescription()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.PropertyMediator.Properties.value == event.getAffectedEditor()) {
            propertyMediator.setValue((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.PropertyMediator.Properties.expression == event.getAffectedEditor()) {
            propertyMediator.setExpression((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PropertyMediator.Properties.namespacePrefix == event.getAffectedEditor()) {
            propertyMediator.setNamespacePrefix((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PropertyMediator.Properties.namespace == event.getAffectedEditor()) {
            propertyMediator.setNamespace((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.PropertyMediator.Properties.oM == event.getAffectedEditor()) {
            propertyMediator.setOM((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PropertyMediator.Properties.valueStringPattern == event.getAffectedEditor()) {
            propertyMediator.setValueStringPattern((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PropertyMediator.Properties.valueStringCapturingGroup == event.getAffectedEditor()) {
            propertyMediator.setValueStringCapturingGroup(
        ...
        if (EsbViewsRepository.PropertyMediator.Properties.newPropertyName == event.getAffectedEditor()) {
            propertyMediator.setNewPropertyName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.PropertyMediator.Properties.description == event.getAffectedEditor()) {
            propertyMediator.setDescription((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_PropertyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.propertyName))
                basePart.setPropertyName((PropertyName) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPropertyMediator_PropertyDataType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.propertyDataType))
                basePart.setPropertyDataType((PropertyDataType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPropertyMediator_PropertyAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.propertyAction))
                basePart.setPropertyAction((PropertyAction) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPropertyMediator_PropertyScope().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.propertyScope))
                basePart.setPropertyScope((PropertyScope) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPropertyMediator_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.valueType))
                basePart.setValueType((PropertyValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPropertyMediator_Value().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.value)) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_Expression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.expression)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_NamespacePrefix().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.namespacePrefix)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_Namespace().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.namespace)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_Boolean().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.boolean_))
                basePart.setBoolean_((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPropertyMediator_OM().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.oM)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_ValueStringPattern().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.valueStringPattern)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_ValueStringCapturingGroup().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.valueStringCapturingGroup)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_NewPropertyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.newPropertyName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPropertyMediator_ValueExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.valueExpression)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PropertyMediator.Properties.description)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getPropertyMediator_PropertyAction(),
                EsbPackage.eINSTANCE.getPropertyMediator_PropertyScope(),
                EsbPackage.eINSTANCE.getPropertyMediator_ValueType(), EsbPackage.eINSTANCE.getPropertyMediator_Value(),
                ...
                EsbPackage.eINSTANCE.getPropertyMediator_Boolean(), EsbPackage.eINSTANCE.getPropertyMediator_OM(),
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.PropertyMediator.Properties.propertyName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_PropertyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_PropertyName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.propertyDataType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_PropertyDataType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_PropertyDataType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.propertyAction == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_PropertyAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_PropertyAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.propertyScope == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_PropertyScope().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_PropertyScope().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_ValueType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_ValueType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.value == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_Value().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getPropertyMediator_Value().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.expression == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_Expression().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_Expression().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.namespacePrefix == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_NamespacePrefix().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_NamespacePrefix().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.namespace == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_Namespace().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_Namespace().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.boolean_ == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_Boolean().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getPropertyMediator_Boolean().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.oM == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_OM().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getPropertyMediator_OM().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.valueStringPattern == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_ValueStringPattern().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_ValueStringPattern().getEAttributeType(),
                ...
                if (EsbViewsRepository.PropertyMediator.Properties.valueStringCapturingGroup == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getPropertyMediator_ValueStringCapturingGroup().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_ValueStringCapturingGroup().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.newPropertyName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPropertyMediator_NewPropertyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPropertyMediator_NewPropertyName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PropertyMediator.Properties.description == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
