...
public class StoreMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public StoreMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject storeMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.StoreMediator.Properties.messageStore))
                basePart.setMessageStore(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        storeMediator.getMessageStore()));

            if (isAccessible(EsbViewsRepository.StoreMediator.Properties.availableMessageStores))
                basePart.setAvailableMessageStores(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        storeMediator.getAvailableMessageStores()));

            if (isAccessible(EsbViewsRepository.StoreMediator.Properties.specifyAs)) {
                basePart.initSpecifyAs(
                        EEFUtils.choiceOfValues(storeMediator, EsbPackage.eINSTANCE.getStoreMediator_SpecifyAs()),
                        storeMediator.getSpecifyAs());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.StoreMediator.Properties.description == event.getAffectedEditor()) {
            storeMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.StoreMediator.Properties.messageStore == event.getAffectedEditor()) {
            storeMediator.setMessageStore((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.StoreMediator.Properties.availableMessageStores == event.getAffectedEditor()) {
            storeMediator.setAvailableMessageStores((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.StoreMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.StoreMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.StoreMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getStoreMediator_MessageStore().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.StoreMediator.Properties.messageStore)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getStoreMediator_AvailableMessageStores().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.StoreMediator.Properties.availableMessageStores)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getStoreMediator_SpecifyAs().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.StoreMediator.Properties.specifyAs))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getStoreMediator_MessageStore(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.StoreMediator.Properties.messageStore == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getStoreMediator_MessageStore().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getStoreMediator_MessageStore().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.StoreMediator.Properties.availableMessageStores == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getStoreMediator_AvailableMessageStores().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getStoreMediator_AvailableMessageStores().getEAttributeType(),
                ...
                if (EsbViewsRepository.StoreMediator.Properties.specifyAs == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getStoreMediator_SpecifyAs().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getStoreMediator_SpecifyAs().getEAttributeType(), newValue);
                }
