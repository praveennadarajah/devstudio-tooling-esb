...
import org.wso2.developerstudio.eclipse.gmf.esb.parts.PropertyGroupMediatorInputConnectorPropertiesEditionPart;
...
public class PropertyGroupMediatorInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
     ...
     */
    public PropertyGroupMediatorInputConnectorPropertiesEditionPartForm() {
        super();
    }
     ...
     * 
     */
    public PropertyGroupMediatorInputConnectorPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence propertyGroupMediatorInputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        propertyGroupMediatorInputConnectorStep
                .addStep(EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.class)
                .addStep(EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.incomingLinks);

        composer = new PartComposer(propertyGroupMediatorInputConnectorStep) {

            @Override
            public Composite addToPart(Composite parent, Object key) {
                if (key == EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.class) {
                    return createPropertiesGroup(widgetFactory, parent);
                }
                if (key == EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.incomingLinks) {
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection
                .setText(EsbMessages.PropertyGroupMediatorInputConnectorPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.incomingLinks,
                        EsbMessages.PropertyGroupMediatorInputConnectorPropertiesEditionPart_IncomingLinksLabel),
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PropertyGroupMediatorInputConnectorPropertiesEditionPartForm.this,
                            EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.incomingLinks,
        ...
        incomingLinks.setID(EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.incomingLinks);
    ...
    protected void moveIncomingLinks(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(
                new PropertiesEditionEvent(PropertyGroupMediatorInputConnectorPropertiesEditionPartForm.this,
                        EsbViewsRepository.PropertyGroupMediatorInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PropertyGroupMediatorInputConnectorPropertiesEditionPart#initIncomingLinks(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
     */
    public void initIncomingLinks(ReferencesTableSettings settings) {
        ...
        if (eefElementEditorReadOnlyState && incomingLinks.getTable().isEnabled()) {
            ...
            incomingLinks.setToolTipText(EsbMessages.PropertyGroupMediatorInputConnector_ReadOnly);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PropertyGroupMediatorInputConnectorPropertiesEditionPart#updateIncomingLinks()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PropertyGroupMediatorInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PropertyGroupMediatorInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PropertyGroupMediatorInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
    ...
    public String getTitle() {
        return EsbMessages.PropertyGroupMediatorInputConnector_Part_Title;
    }
