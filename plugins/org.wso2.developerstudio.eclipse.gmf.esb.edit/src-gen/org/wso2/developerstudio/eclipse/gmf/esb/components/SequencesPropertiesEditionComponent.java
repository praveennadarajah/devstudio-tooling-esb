...
public class SequencesPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public SequencesPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject sequences,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.Sequences.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, sequences.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.Sequences.Properties.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(sequences,
                ...
                basePart.addFilterToTemplateParameters(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof TemplateParameter);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.Sequences.Properties.description == event.getAffectedEditor()) {
            sequences.setDescription((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.Sequences.Properties.name == event.getAffectedEditor()) {
            sequences.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.Sequences.Properties.templateParameters == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, templateParametersSettings, editingContext.getAdapterFactory());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.Sequences.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequences.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getSequences_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequences.Properties.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSequences_RecieveSequence().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequences.Properties.recieveSequence))
                basePart.setRecieveSequence((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSequences_AssociatedProxy().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequences.Properties.associatedProxy)) {
                if (msg.getNewValue() instanceof EList<?>) {
            ...
            if (EsbPackage.eINSTANCE.getSequences_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.Sequences.Properties.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getSequences_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequences.Properties.traceEnabled))
                basePart.setTraceEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSequences_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequences.Properties.statisticsEnabled))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getSequences_Name(), EsbPackage.eINSTANCE.getSequences_RecieveSequence(),
                EsbPackage.eINSTANCE.getSequences_AssociatedProxy(),
                EsbPackage.eINSTANCE.getSequences_TemplateParameters(),
                EsbPackage.eINSTANCE.getSequences_TraceEnabled(), EsbPackage.eINSTANCE.getSequences_StatisticsEnabled(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.Sequences.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequences_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getSequences_Name().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Sequences.Properties.recieveSequence == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequences_RecieveSequence().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSequences_RecieveSequence().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.Sequences.Properties.associatedProxy == event.getAffectedEditor()) {
                    BasicDiagnostic chain = new BasicDiagnostic();
                    for (Iterator iterator = ((List) event.getNewValue()).iterator(); iterator.hasNext();) {
                        chain.add(Diagnostician.INSTANCE.validate(
                                EsbPackage.eINSTANCE.getSequences_AssociatedProxy().getEAttributeType(),
                                iterator.next()));
                    }
                    ret = chain;
                }
                if (EsbViewsRepository.Sequences.Properties.traceEnabled == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequences_TraceEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSequences_TraceEnabled().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.Sequences.Properties.statisticsEnabled == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequences_StatisticsEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSequences_StatisticsEnabled().getEAttributeType(), newValue);
                }
