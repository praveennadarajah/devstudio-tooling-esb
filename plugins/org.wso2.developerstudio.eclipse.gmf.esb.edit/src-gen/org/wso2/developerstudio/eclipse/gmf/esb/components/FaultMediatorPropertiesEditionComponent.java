...
public class FaultMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public FaultMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject faultMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.soapVersion)) {
                basePart.initSoapVersion(
                        EEFUtils.choiceOfValues(faultMediator, EsbPackage.eINSTANCE.getFaultMediator_SoapVersion()),
                        faultMediator.getSoapVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11)) {
                basePart.initFaultCodeSoap11(
                        EEFUtils.choiceOfValues(faultMediator, EsbPackage.eINSTANCE.getFaultMediator_FaultCodeSoap11()),
                        faultMediator.getFaultCodeSoap11());
            }
            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultCodeType)) {
                basePart.initFaultCodeType(
                        EEFUtils.choiceOfValues(faultMediator, EsbPackage.eINSTANCE.getFaultMediator_FaultCodeType()),
                        faultMediator.getFaultCodeType());
            }
            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultStringType)) {
                basePart.initFaultStringType(
                        EEFUtils.choiceOfValues(faultMediator, EsbPackage.eINSTANCE.getFaultMediator_FaultStringType()),
                        faultMediator.getFaultStringType());
            }
            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultStringValue))
                basePart.setFaultStringValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        faultMediator.getFaultStringValue()));

            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultActor))
                basePart.setFaultActor(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, faultMediator.getFaultActor()));

            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12)) {
                basePart.initFaultCodeSoap12(
                        EEFUtils.choiceOfValues(faultMediator, EsbPackage.eINSTANCE.getFaultMediator_FaultCodeSoap12()),
                        faultMediator.getFaultCodeSoap12());
            }
            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultReasonType)) {
                basePart.initFaultReasonType(
                        EEFUtils.choiceOfValues(faultMediator, EsbPackage.eINSTANCE.getFaultMediator_FaultReasonType()),
                        faultMediator.getFaultReasonType());
            }
            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultReasonValue))
                basePart.setFaultReasonValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        faultMediator.getFaultReasonValue()));

            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.roleName))
                basePart.setRoleName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, faultMediator.getRoleName()));

            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.nodeName))
                basePart.setNodeName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, faultMediator.getNodeName()));

            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultDetailType)) {
                basePart.initFaultDetailType(
                        EEFUtils.choiceOfValues(faultMediator, EsbPackage.eINSTANCE.getFaultMediator_FaultDetailType()),
                        faultMediator.getFaultDetailType());
            }
            if (isAccessible(EsbViewsRepository.FaultMediator.Properties.faultDetailValue))
                basePart.setFaultDetailValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        faultMediator.getFaultDetailValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.FaultMediator.Properties.description == event.getAffectedEditor()) {
            faultMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.FaultMediator.Properties.faultStringValue == event.getAffectedEditor()) {
            faultMediator.setFaultStringValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.FaultMediator.Properties.faultActor == event.getAffectedEditor()) {
            faultMediator.setFaultActor((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.FaultMediator.Properties.faultReasonValue == event.getAffectedEditor()) {
            faultMediator.setFaultReasonValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.FaultMediator.Properties.roleName == event.getAffectedEditor()) {
            faultMediator.setRoleName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.FaultMediator.Properties.nodeName == event.getAffectedEditor()) {
            faultMediator.setNodeName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.FaultMediator.Properties.faultDetailValue == event.getAffectedEditor()) {
            faultMediator.setFaultDetailValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_SoapVersion().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.soapVersion))
                basePart.setSoapVersion((FaultSoapVersion) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_SerializeResponse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.serializeResponse))
                basePart.setSerializeResponse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_MarkAsResponse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.markAsResponse))
                basePart.setMarkAsResponse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_FaultCodeSoap11().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11))
                basePart.setFaultCodeSoap11((FaultCodeSoap11) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_FaultCodeType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultCodeType))
                basePart.setFaultCodeType((FaultCodeType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_FaultStringType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultStringType))
                basePart.setFaultStringType((FaultStringType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_FaultStringValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultStringValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getFaultMediator_FaultActor().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultActor)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getFaultMediator_FaultCodeSoap12().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12))
                basePart.setFaultCodeSoap12((FaultCodeSoap12) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_FaultReasonType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultReasonType))
                basePart.setFaultReasonType((FaultReasonType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_FaultReasonValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultReasonValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getFaultMediator_RoleName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.roleName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getFaultMediator_NodeName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.nodeName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getFaultMediator_FaultDetailType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultDetailType))
                basePart.setFaultDetailType((FaultDetailType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFaultMediator_FaultDetailValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FaultMediator.Properties.faultDetailValue)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getFaultMediator_SoapVersion(),
                ...
                EsbPackage.eINSTANCE.getFaultMediator_RoleName(), EsbPackage.eINSTANCE.getFaultMediator_NodeName(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.FaultMediator.Properties.soapVersion == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_SoapVersion().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_SoapVersion().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.serializeResponse == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_SerializeResponse().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_SerializeResponse().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.markAsResponse == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_MarkAsResponse().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_MarkAsResponse().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11 == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultCodeSoap11().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultCodeSoap11().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultCodeType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultCodeType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultCodeType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultStringType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultStringType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultStringType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultStringValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultStringValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultStringValue().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultActor == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultActor().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getFaultMediator_FaultActor().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12 == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultCodeSoap12().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultCodeSoap12().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultReasonType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultReasonType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultReasonType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultReasonValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultReasonValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultReasonValue().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.roleName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_RoleName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getFaultMediator_RoleName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.nodeName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_NodeName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getFaultMediator_NodeName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultDetailType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultDetailType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultDetailType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FaultMediator.Properties.faultDetailValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFaultMediator_FaultDetailValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFaultMediator_FaultDetailValue().getEAttributeType(), newValue);
                }
