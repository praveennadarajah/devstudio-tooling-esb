...
public class FaultMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addFaultStringExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultStringExpression_feature",
                        "_UI_FaultMediator_type"),
                EsbPackage.Literals.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION, true, false, false,
                ItemPropertyDescriptor.TEXT_VALUE_IMAGE, "Reason", null));
    }
    ...
    protected void addFaultReasonExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultReasonExpression_feature",
                        "_UI_FaultMediator_type"),
                EsbPackage.Literals.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION, true, false, false,
                ItemPropertyDescriptor.TEXT_VALUE_IMAGE, "Reason", null));
    }
    ...
    protected void addFaultDetailExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultDetailExpression_feature",
                        "_UI_FaultMediator_type"),
                EsbPackage.Literals.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION, true, false, false,
                ItemPropertyDescriptor.TEXT_VALUE_IMAGE, "Detail", null));
    }
    ...
    protected void addFaultCodeSoap11PropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FaultMediator_faultCodeSoap11_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultCodeSoap11_feature",
                                "_UI_FaultMediator_type"),
                        EsbPackage.Literals.FAULT_MEDIATOR__FAULT_CODE_SOAP11, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Code", null));
    }
    ...
    protected void addFaultStringTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FaultMediator_faultStringType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultStringType_feature",
                                "_UI_FaultMediator_type"),
                        EsbPackage.Literals.FAULT_MEDIATOR__FAULT_STRING_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Reason", null));
    }
    ...
    protected void addFaultStringValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FaultMediator_faultStringValue_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultStringValue_feature",
                                "_UI_FaultMediator_type"),
                        EsbPackage.Literals.FAULT_MEDIATOR__FAULT_STRING_VALUE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Reason", null));
    }
    ...
    protected void addFaultCodeSoap12PropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FaultMediator_faultCodeSoap12_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultCodeSoap12_feature",
                                "_UI_FaultMediator_type"),
                        EsbPackage.Literals.FAULT_MEDIATOR__FAULT_CODE_SOAP12, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Code", null));
    }
    ...
    protected void addFaultReasonTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FaultMediator_faultReasonType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultReasonType_feature",
                                "_UI_FaultMediator_type"),
                        EsbPackage.Literals.FAULT_MEDIATOR__FAULT_REASON_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Reason", null));
    }
    ...
    protected void addFaultReasonValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FaultMediator_faultReasonValue_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultReasonValue_feature",
                                "_UI_FaultMediator_type"),
                        EsbPackage.Literals.FAULT_MEDIATOR__FAULT_REASON_VALUE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Reason", null));
    }
    ...
    protected void addFaultDetailTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FaultMediator_faultDetailType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultDetailType_feature",
                                "_UI_FaultMediator_type"),
                        EsbPackage.Literals.FAULT_MEDIATOR__FAULT_DETAIL_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Detail", null));
    }
    ...
    protected void addFaultDetailValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_FaultMediator_faultDetailValue_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_FaultMediator_faultDetailValue_feature",
                                "_UI_FaultMediator_type"),
                        EsbPackage.Literals.FAULT_MEDIATOR__FAULT_DETAIL_VALUE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Detail", null));
    }
