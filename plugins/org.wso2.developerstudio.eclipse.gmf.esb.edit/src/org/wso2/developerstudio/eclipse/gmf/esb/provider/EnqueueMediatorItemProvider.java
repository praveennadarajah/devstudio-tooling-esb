    ...
    protected void addSequenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnqueueMediator_sequenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnqueueMediator_sequenceKey_feature",
                                "_UI_EnqueueMediator_type"),
                        EsbPackage.Literals.ENQUEUE_MEDIATOR__SEQUENCE_KEY, true, false, true, null, null, null));
    }
