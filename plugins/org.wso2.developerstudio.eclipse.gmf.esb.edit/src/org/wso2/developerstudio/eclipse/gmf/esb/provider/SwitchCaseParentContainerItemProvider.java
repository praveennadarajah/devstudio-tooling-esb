...
public class SwitchCaseParentContainerItemProvider extends EsbNodeItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.SWITCH_CASE_PARENT_CONTAINER__SWITCH_CASE_CONTAINER);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SwitchCaseParentContainer"));
	}
    ...
    public String getText(Object object) {
		return getString("_UI_SwitchCaseParentContainer_type");
	}
