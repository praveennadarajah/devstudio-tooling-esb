...
public class LoopBackMediatorItemProvider extends MediatorItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.LOOP_BACK_MEDIATOR__INPUT_CONNECTOR);
			childrenFeatures.add(EsbPackage.Literals.LOOP_BACK_MEDIATOR__OUTPUT_CONNECTOR);
		}
