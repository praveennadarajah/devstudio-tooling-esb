...
public class EntitlementObligationsContainerItemProvider extends EsbNodeItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.ENTITLEMENT_OBLIGATIONS_CONTAINER__MEDIATOR_FLOW);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EntitlementObligationsContainer"));
	}
    ...
    public String getText(Object object) {
		return getString("_UI_EntitlementObligationsContainer_type");
	}
