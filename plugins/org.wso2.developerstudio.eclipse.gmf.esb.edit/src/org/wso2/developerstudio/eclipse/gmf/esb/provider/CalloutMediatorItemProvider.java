...
public class CalloutMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addServiceURLPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_CalloutMediator_serviceURL_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_serviceURL_feature",
                                "_UI_CalloutMediator_type"),
                        EsbPackage.Literals.CALLOUT_MEDIATOR__SERVICE_URL, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Service", null));
    }
    ...
    protected void addSoapActionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_CalloutMediator_soapAction_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_soapAction_feature",
                                "_UI_CalloutMediator_type"),
                        EsbPackage.Literals.CALLOUT_MEDIATOR__SOAP_ACTION, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Service", null));
    }
    ...
    protected void addPathToAxis2xmlPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_CalloutMediator_pathToAxis2xml_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_pathToAxis2xml_feature",
                                "_UI_CalloutMediator_type"),
                        EsbPackage.Literals.CALLOUT_MEDIATOR__PATH_TO_AXIS2XML, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Service", null));
    }
    ...
    protected void addPathToAxis2RepositoryPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_pathToAxis2Repository_feature",
                        "_UI_CalloutMediator_type"),
                EsbPackage.Literals.CALLOUT_MEDIATOR__PATH_TO_AXIS2_REPOSITORY, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Service", null));
    }
    ...
    protected void addPayloadMessageXpathPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_payloadMessageXpath_feature",
                        "_UI_CalloutMediator_type"),
                EsbPackage.Literals.CALLOUT_MEDIATOR__PAYLOAD_MESSAGE_XPATH, true, false, false, null, "Source", null));
    }
     ...
     * getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_payloadRegistryKey_feature",
     * "_UI_CalloutMediator_type"),
    ...
    protected void addResultMessageXpathPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_resultMessageXpath_feature",
                        "_UI_CalloutMediator_type"),
                EsbPackage.Literals.CALLOUT_MEDIATOR__RESULT_MESSAGE_XPATH, true, false, false, null, "Target", null));
    }
    ...
    protected void addPayloadTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_CalloutMediator_payloadType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_payloadType_feature",
                                "_UI_CalloutMediator_type"),
                        EsbPackage.Literals.CALLOUT_MEDIATOR__PAYLOAD_TYPE, true, false, false,
    ...
    protected void addResultTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_CalloutMediator_resultType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_resultType_feature",
                                "_UI_CalloutMediator_type"),
                        EsbPackage.Literals.CALLOUT_MEDIATOR__RESULT_TYPE, true, false, false,
    ...
    protected void addResultContextPropertyPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_resultContextProperty_feature",
                        "_UI_CalloutMediator_type"),
                EsbPackage.Literals.CALLOUT_MEDIATOR__RESULT_CONTEXT_PROPERTY, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Target", null));
    }
    ...
    protected void addInitAxis2ClientOptionsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_CalloutMediator_initAxis2ClientOptions_feature",
                        "_UI_CalloutMediator_type"),
                EsbPackage.Literals.CALLOUT_MEDIATOR__INIT_AXIS2_CLIENT_OPTIONS, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Service", null));
    }
