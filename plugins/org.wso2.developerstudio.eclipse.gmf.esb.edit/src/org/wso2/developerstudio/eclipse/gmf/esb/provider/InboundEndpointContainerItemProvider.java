...
public class InboundEndpointContainerItemProvider extends EsbElementItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.INBOUND_ENDPOINT_CONTAINER__SEQUENCE_CONTAINER);
			childrenFeatures.add(EsbPackage.Literals.INBOUND_ENDPOINT_CONTAINER__ON_ERROR_SEQUENCE_CONTAINER);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InboundEndpointContainer"));
	}
