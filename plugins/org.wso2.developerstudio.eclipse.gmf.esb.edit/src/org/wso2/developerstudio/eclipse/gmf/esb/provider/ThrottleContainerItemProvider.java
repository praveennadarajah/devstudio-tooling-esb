...
public class ThrottleContainerItemProvider extends EsbNodeItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.THROTTLE_CONTAINER__ON_ACCEPT_CONTAINER);
			childrenFeatures.add(EsbPackage.Literals.THROTTLE_CONTAINER__ON_REJECT_CONTAINER);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ThrottleContainer"));
	}
    ...
    public String getText(Object object) {
		return getString("_UI_ThrottleContainer_type");
	}
