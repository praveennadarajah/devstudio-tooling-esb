...
public class FilterFailContainerItemProvider extends EsbNodeItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.FILTER_FAIL_CONTAINER__MEDIATOR_FLOW);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FilterFailContainer"));
	}
    ...
    public String getText(Object object) {
		return getString("_UI_FilterFailContainer_type");
	}
