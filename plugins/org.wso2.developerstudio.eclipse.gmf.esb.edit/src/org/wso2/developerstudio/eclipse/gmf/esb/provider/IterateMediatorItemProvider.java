 ...
 * @generated
 */
public class IterateMediatorItemProvider extends MediatorItemProvider {
    /**
    ...
    protected void addIterateExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_IterateMediator_iterateExpression_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_iterateExpression_feature",
                                "_UI_IterateMediator_type"),
                        EsbPackage.Literals.ITERATE_MEDIATOR__ITERATE_EXPRESSION, true, false, false, null, null,
                        null));
    }
    ...
    protected void addAttachPathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_IterateMediator_attachPath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_attachPath_feature",
                                "_UI_IterateMediator_type"),
                        EsbPackage.Literals.ITERATE_MEDIATOR__ATTACH_PATH, true, false, false, null, null, null));
    }
