...
public class EnrichMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addSourceXpathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_sourceXpath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_sourceXpath_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__SOURCE_XPATH, true, false, false,
                        ItemPropertyDescriptor.TEXT_VALUE_IMAGE, "Source", null));
    }

    protected void addTargetXpathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_targetXpath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_targetXpath_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__TARGET_XPATH, true, false, false,
                        ItemPropertyDescriptor.TEXT_VALUE_IMAGE, "Target", null));
    }
    ...
    protected void addCloneSourcePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_cloneSource_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_cloneSource_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__CLONE_SOURCE, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, "Source", null));
    }
    ...
    protected void addSourceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_sourceType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_sourceType_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__SOURCE_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Source", null));
    }
    ...
    protected void addSourcePropertyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_sourceProperty_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_sourceProperty_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__SOURCE_PROPERTY, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Source", null));
    }
    ...
    protected void addSourceXMLPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_sourceXML_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_sourceXML_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__SOURCE_XML, true, true, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Source", null));
    }
    ...
    protected void addTargetActionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_targetAction_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_targetAction_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__TARGET_ACTION, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Target", null));
    }
    ...
    protected void addTargetTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_targetType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_targetType_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__TARGET_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Target", null));
    }
    ...
    protected void addTargetPropertyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_targetProperty_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_targetProperty_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__TARGET_PROPERTY, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Target", null));
    }
    ...
    protected void addInlineTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_inlineType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_inlineType_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__INLINE_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Source", null));
    }
    ...
    protected void addInlineRegistryKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EnrichMediator_inlineRegistryKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EnrichMediator_inlineRegistryKey_feature",
                                "_UI_EnrichMediator_type"),
                        EsbPackage.Literals.ENRICH_MEDIATOR__INLINE_REGISTRY_KEY, true, false, false, null, "Source",
                        null));
    }
