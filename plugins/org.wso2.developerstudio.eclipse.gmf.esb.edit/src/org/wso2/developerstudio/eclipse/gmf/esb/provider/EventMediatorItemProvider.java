 ...
 * @generated
 */
public class EventMediatorItemProvider extends MediatorItemProvider {
    /**
    ...
    protected void addDynamicTopicPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EventMediator_dynamicTopic_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EventMediator_dynamicTopic_feature",
                                "_UI_EventMediator_type"),
                        EsbPackage.Literals.EVENT_MEDIATOR__DYNAMIC_TOPIC, true, false, true, null, null, null));
    }

    protected void addEventExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EventMediator_eventExpression_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EventMediator_eventExpression_feature",
                                "_UI_EventMediator_type"),
                        EsbPackage.Literals.EVENT_MEDIATOR__EVENT_EXPRESSION, true, false, true, null, null, null));
    }
