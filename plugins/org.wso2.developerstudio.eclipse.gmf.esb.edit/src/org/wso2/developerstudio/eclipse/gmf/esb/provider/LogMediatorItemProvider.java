    ...
    protected void addLogPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LogMediator_properties_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LogMediator_properties_feature",
                                "_UI_LogMediator_type"),
                        EsbPackage.Literals.LOG_MEDIATOR__PROPERTIES, true, false, false, null, null, null));
    }
