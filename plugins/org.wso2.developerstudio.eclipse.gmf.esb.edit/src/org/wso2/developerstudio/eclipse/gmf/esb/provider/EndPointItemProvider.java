...
public class EndPointItemProvider extends EsbElementItemProvider {
    ...
    protected void addEndPointNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EndPoint_endPointName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EndPoint_endPointName_feature",
                                "_UI_EndPoint_type"),
                        EsbPackage.Literals.END_POINT__END_POINT_NAME, true, false, false,
    ...
    protected void addInLinePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EndPoint_InLine_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EndPoint_InLine_feature",
                                "_UI_EndPoint_type"),
                        EsbPackage.Literals.END_POINT__IN_LINE, true, false, false,
