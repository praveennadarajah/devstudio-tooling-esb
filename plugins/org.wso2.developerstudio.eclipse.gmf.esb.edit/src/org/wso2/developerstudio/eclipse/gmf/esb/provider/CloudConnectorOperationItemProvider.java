...
public class CloudConnectorOperationItemProvider extends MediatorItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        ...
        Iterator<CallTemplateParameter> iterator = ((CloudConnectorOperation) object).getConnectorParameters()
                .iterator();
    ...
    protected void addCustomConnectorParametersPropertyDescriptor(Object object,
            CallTemplateParameter callTemplateParameter) {
        itemPropertyDescriptors.add(new ItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                callTemplateParameter.getParameterName(), "Cloud connector operation parameter", null, true, false,
            ...
            public Object getPropertyValue(Object object) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (displayName.equals(callTemplateParameter.getParameterName())) {
                        if (((CloudConnectorOperation) object).getParameterEditorType()
                                .equals(CloudConnectorOperationParamEditorType.INLINE)) {
                            return createPropertyValueWrapper(object, callTemplateParameter.getParameterValue());
                        } else if (((CloudConnectorOperation) object).getParameterEditorType()
                                .equals(CloudConnectorOperationParamEditorType.NAMESPACED_PROPERTY_EDITOR)) {
                            return createPropertyValueWrapper(object,
                                    callTemplateParameter.getParameterExpression().getPropertyValue());
                        }
                    }
                }
                return null;
