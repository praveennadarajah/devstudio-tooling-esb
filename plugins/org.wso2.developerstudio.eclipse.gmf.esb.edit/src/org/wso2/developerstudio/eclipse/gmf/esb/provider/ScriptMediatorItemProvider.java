 ...
 * @generated
 */
public class ScriptMediatorItemProvider extends MediatorItemProvider {
    /**
    ...
    protected void addScriptBodyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ScriptMediator_scriptBody_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ScriptMediator_scriptBody_feature",
                                "_UI_ScriptMediator_type"),
                        EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_BODY, true, true, false,
