 ...
 * @generated
 */
public class XSLTMediatorItemProvider extends MediatorItemProvider {
    /**
    ...
    protected void addXsltKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_XSLTMediator_xsltKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XSLTMediator_xsltKey_feature",
                                "_UI_XSLTMediator_type"),
                        EsbPackage.Literals.XSLT_MEDIATOR__XSLT_KEY, true, false, false, null, null, null));
    }
    ...
    protected void addSourceXPathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_XSLTMediator_sourceXPath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XSLTMediator_sourceXPath_feature",
                                "_UI_XSLTMediator_type"),
                        EsbPackage.Literals.XSLT_MEDIATOR__SOURCE_XPATH, true, false, false, null, "Basic", null));
    }
    ...
    protected void addPropertiesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_XSLTMediator_properties_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XSLTMediator_properties_feature",
                                "_UI_XSLTMediator_type"),
                        EsbPackage.Literals.XSLT_MEDIATOR__PROPERTIES, true, false, false, null, null, null));
    }
    ...
    protected void addResourcesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_XSLTMediator_resources_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XSLTMediator_resources_feature",
                                "_UI_XSLTMediator_type"),
                        EsbPackage.Literals.XSLT_MEDIATOR__RESOURCES, true, false, false, null, null, null));
    }
    ...
    protected void addFeaturesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_XSLTMediator_features_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XSLTMediator_resources_feature",
                                "_UI_XSLTMediator_type"),
                        EsbPackage.Literals.XSLT_MEDIATOR__FEATURES, true, false, false, null, null, null));
    }

    protected void addXsltStaticSchemaKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_XSLTMediator_xsltStaticSchemaKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XSLTMediator_xsltStaticSchemaKey_feature",
                                "_UI_XSLTMediator_type"),
                        EsbPackage.Literals.XSLT_MEDIATOR__XSLT_STATIC_SCHEMA_KEY, true, false, true, null, "Basic",
                        null));
    }
    ...
    protected void addXsltDynamicSchemaKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_XSLTMediator_xsltDynamicSchemaKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XSLTMediator_xsltDynamicSchemaKey_feature",
                                "_UI_XSLTMediator_type"),
                        EsbPackage.Literals.XSLT_MEDIATOR__XSLT_DYNAMIC_SCHEMA_KEY, true, false, true, null, "Basic",
                        null));
    }
