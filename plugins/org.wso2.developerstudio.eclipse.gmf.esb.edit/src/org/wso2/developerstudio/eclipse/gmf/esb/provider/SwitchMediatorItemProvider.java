...
public class SwitchMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addConfigureCaseBranchesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_SwitchMediator_caseBranches_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XSLTMediator_xsltKey_feature",
                                "_UI_SwitchMediator_type"),
                        EsbPackage.Literals.SWITCH_MEDIATOR__CASE_BRANCHES, true, false, false, null, null, null));
    }
    ...
    protected void addSourceXPathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_SwitchMediator_sourceXpath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_SwitchMediator_sourceXpath_feature",
                                "_UI_SwitchMediator_type"),
                        EsbPackage.Literals.SWITCH_MEDIATOR__SOURCE_XPATH, true, false, false, null, null, null));
    }
