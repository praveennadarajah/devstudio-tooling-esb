...
public class ProxyServiceContainerItemProvider extends EsbNodeItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.PROXY_SERVICE_CONTAINER__SEQUENCE_AND_ENDPOINT_CONTAINER);
			childrenFeatures.add(EsbPackage.Literals.PROXY_SERVICE_CONTAINER__FAULT_CONTAINER);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProxyServiceContainer"));
	}
    ...
    public String getText(Object object) {
		return getString("_UI_ProxyServiceContainer_type");
	}
