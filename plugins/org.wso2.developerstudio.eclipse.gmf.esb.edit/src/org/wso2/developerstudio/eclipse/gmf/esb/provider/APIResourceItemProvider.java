...
public class APIResourceItemProvider extends EsbNodeItemProvider {
    ...
    protected void addAllowPatchPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_APIResource_allowPatch_feature",
                        "_UI_APIResource_type"),
                EsbPackage.Literals.API_RESOURCE__ALLOW_PATCH, true, false, false,
    ...
    protected void addInSequenceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_inSequenceType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_inSequenceType_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__IN_SEQUENCE_TYPE, true, false, false,
    ...
    protected void addInSequenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_inSequenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_inSequenceKey_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__IN_SEQUENCE_KEY, true, false, false, null, "In Sequence",
                        null));
    }
    ...
    protected void addInSequenceNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_inSequenceName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_inSequenceName_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__IN_SEQUENCE_NAME, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "In Sequence", null));
    }
    ...
    protected void addOutSequenceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_outSequenceType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_outSequenceType_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__OUT_SEQUENCE_TYPE, true, false, false,
    ...
    protected void addOutSequenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_outSequenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_outSequenceKey_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__OUT_SEQUENCE_KEY, true, false, false, null, "Out Sequence",
                        null));
    }
    ...
    protected void addOutSequenceNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_outSequenceName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_outSequenceName_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__OUT_SEQUENCE_NAME, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Out Sequence", null));
    }
    ...
    protected void addFaultSequenceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_faultSequenceType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_faultSequenceType_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__FAULT_SEQUENCE_TYPE, true, false, false,
    ...
    protected void addFaultSequenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_faultSequenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_faultSequenceKey_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__FAULT_SEQUENCE_KEY, true, false, false, null,
                        "Fault Sequence", null));
    }
    ...
    protected void addFaultSequenceNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_faultSequenceName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_faultSequenceName_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__FAULT_SEQUENCE_NAME, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Fault Sequence", null));
    }
    ...
    protected void addProtocolPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_APIResource_protocol_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_APIResource_protocol_feature",
                                "_UI_APIResource_type"),
                        EsbPackage.Literals.API_RESOURCE__PROTOCOL, true, false, false,
