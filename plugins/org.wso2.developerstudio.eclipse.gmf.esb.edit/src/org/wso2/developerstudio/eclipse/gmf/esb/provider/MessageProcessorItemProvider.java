...
public class MessageProcessorItemProvider extends EsbElementItemProvider {
    ...
    protected void addDropMessageAfterMaximumDeliveryAttemptsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description",
                        "_UI_MessageProcessor_dropMessageAfterMaximumDeliveryAttempts_feature",
                        "_UI_MessageProcessor_type"),
                EsbPackage.Literals.MESSAGE_PROCESSOR__DROP_MESSAGE_AFTER_MAXIMUM_DELIVERY_ATTEMPTS, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_AdditionalParametersPropertyCategory"),
                null));
    }
    ...
    protected void addDeactivateSequenceNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_MessageProcessor_deactivateSequenceName_feature",
                        "_UI_MessageProcessor_type"),
                EsbPackage.Literals.MESSAGE_PROCESSOR__DEACTIVATE_SEQUENCE_NAME, true, false, true, null,
                getString("_UI_AdditionalParametersPropertyCategory"), null));
    }
    ...
    protected void addTaskCountPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageProcessor_taskCount_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_MessageProcessor_taskCount_feature",
                                "_UI_MessageProcessor_type"),
                        EsbPackage.Literals.MESSAGE_PROCESSOR__TASK_COUNT, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                        getString("_UI_AdditionalParametersPropertyCategory"), null));
    }
    ...
    protected void addMaxStoreConnectionAttemptsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageProcessor_maxStoreConnectionAttempts_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_MessageProcessor_maxStoreConnectionAttempts_feature", "_UI_MessageProcessor_type"),
                        EsbPackage.Literals.MESSAGE_PROCESSOR__MAX_STORE_CONNECTION_ATTEMPTS, true, false, false,
    ...
    protected void addStoreConnectionIntervalPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_MessageProcessor_storeConnectionInterval_feature",
                        "_UI_MessageProcessor_type"),
                EsbPackage.Literals.MESSAGE_PROCESSOR__STORE_CONNECTION_INTERVAL, true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addFailMessagesStorePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_MessageProcessor_failMessagesStore_feature",
                        "_UI_MessageProcessor_type"),
                EsbPackage.Literals.MESSAGE_PROCESSOR__FAIL_MESSAGES_STORE, true, false, false,
