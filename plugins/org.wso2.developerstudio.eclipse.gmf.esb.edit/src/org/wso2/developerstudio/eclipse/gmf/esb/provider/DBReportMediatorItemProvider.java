    ...
    protected void addConnectionUseTransactionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_DBReportMediator_connectionUseTransaction_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_DBReportMediator_connectionUseTransaction_feature", "_UI_DBReportMediator_type"),
                        EsbPackage.Literals.DB_REPORT_MEDIATOR__CONNECTION_USE_TRANSACTION, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, "Connection", null));
    }
