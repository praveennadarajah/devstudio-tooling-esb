    ...
    protected void addConfigurationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(new ItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_DataMapperMediator_configuration_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_DataMapperMediator_configuration_feature",
                                "_UI_DataMapperMediator_type"),
                        EsbPackage.Literals.DATA_MAPPER_MEDIATOR__CONFIGURATION, true, false, false, null, null, null) {
                    @Override
                    public void setPropertyValue(Object object, Object value) {
                        ...
                        if (value instanceof RegistryKeyPropertyImpl) {
                            ...
                            SetCommand setCmd = new SetCommand(editingDomain, datamapperMediator,
