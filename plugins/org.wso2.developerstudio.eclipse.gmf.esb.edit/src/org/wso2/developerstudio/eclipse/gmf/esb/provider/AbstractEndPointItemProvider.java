...
public class AbstractEndPointItemProvider extends EndPointItemProvider {
    ...
    protected void addReliableMessagingEnabledPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractEndPoint_reliableMessagingEnabled_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_AbstractEndPoint_reliableMessagingEnabled_feature", "_UI_AbstractEndPoint_type"),
                        EsbPackage.Literals.ABSTRACT_END_POINT__RELIABLE_MESSAGING_ENABLED, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, "QoS", null));
    }
    ...
    protected void addSecurityEnabledPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractEndPoint_securityEnabled_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_securityEnabled_feature",
                                "_UI_AbstractEndPoint_type"),
                        EsbPackage.Literals.ABSTRACT_END_POINT__SECURITY_ENABLED, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, "QoS", null));
    }
    ...
    protected void addAddressingEnabledPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_addressingEnabled_feature",
                        "_UI_AbstractEndPoint_type"),
                EsbPackage.Literals.ABSTRACT_END_POINT__ADDRESSING_ENABLED, true, false, false,
                ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, "QoS", null));
    }
    ...
    protected void addAddressingVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_addressingVersion_feature",
                        "_UI_AbstractEndPoint_type"),
                EsbPackage.Literals.ABSTRACT_END_POINT__ADDRESSING_VERSION, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "QoS", null));
    }
    ...
    protected void addAddressingSeparateListenerPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractEndPoint_addressingSeparateListener_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_AbstractEndPoint_addressingSeparateListener_feature", "_UI_AbstractEndPoint_type"),
                        EsbPackage.Literals.ABSTRACT_END_POINT__ADDRESSING_SEPARATE_LISTENER, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, "QoS", null));
    }
    ...
    protected void addReliableMessagingPolicyPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_reliableMessagingPolicy_feature",
                        "_UI_AbstractEndPoint_type"),
                EsbPackage.Literals.ABSTRACT_END_POINT__RELIABLE_MESSAGING_POLICY, true, false, true, null, "QoS",
                null));
    }
    ...
    protected void addSecurityPolicyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractEndPoint_securityPolicy_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_securityPolicy_feature",
                                "_UI_AbstractEndPoint_type"),
                        EsbPackage.Literals.ABSTRACT_END_POINT__SECURITY_POLICY, true, false, true, null, "QoS", null));
    }
    ...
    protected void addInboundSecurityPolicyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractEndPoint_inboundPolicy_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_inboundPolicy_feature",
                                "_UI_AbstractEndPoint_type"),
                        EsbPackage.Literals.ABSTRACT_END_POINT__INBOUND_POLICY, true, false, true, null, "QoS", null));
    }
    ...
    protected void addOutboundSecurityPolicyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractEndPoint_outboundPolicy_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_outboundPolicy_feature",
                                "_UI_AbstractEndPoint_type"),
                        EsbPackage.Literals.ABSTRACT_END_POINT__OUTBOUND_POLICY, true, false, true, null, "QoS", null));
    }
    ...
    protected void addFormatPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractEndPoint_format_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_format_feature",
                                "_UI_AbstractEndPoint_type"),
                        EsbPackage.Literals.ABSTRACT_END_POINT__FORMAT, true, false, false,
    ...
    protected void addStatisticsEnabledPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_statisticsEnabled_feature",
                        "_UI_AbstractEndPoint_type"),
                EsbPackage.Literals.ABSTRACT_END_POINT__STATISTICS_ENABLED, true, false, false,
    ...
    protected void addTraceEnabledPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractEndPoint_traceEnabled_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractEndPoint_traceEnabled_feature",
                                "_UI_AbstractEndPoint_type"),
                        EsbPackage.Literals.ABSTRACT_END_POINT__TRACE_ENABLED, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, "Basic", null));
    }
