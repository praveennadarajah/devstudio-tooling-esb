...
public class AggregateMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addAggregateIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AggregateMediator_aggregateID_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AggregateMediator_aggregateID_feature",
                                "_UI_AggregateMediator_type"),
                        EsbPackage.Literals.AGGREGATE_MEDIATOR__AGGREGATE_ID, true, false, false,
    ...
    protected void addCorrelationExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AggregateMediator_correlationExpression_feature",
                        "_UI_AggregateMediator_type"),
                EsbPackage.Literals.AGGREGATE_MEDIATOR__CORRELATION_EXPRESSION, true, false, false, null, "Basic",
                null));
    }
    ...
    protected void addCompletionTimeoutPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AggregateMediator_completionTimeout_feature",
                        "_UI_AggregateMediator_type"),
                EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_TIMEOUT, true, false, false,
    ...
    protected void addCompletionMinMessagesTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description",
                        "_UI_AggregateMediator_completionMinMessagesType_feature", "_UI_AggregateMediator_type"),
                EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_MIN_MESSAGES_TYPE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Basic", null));
    }
    ...
    protected void addCompletionMaxMessagesTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description",
                        "_UI_AggregateMediator_completionMaxMessagesType_feature", "_UI_AggregateMediator_type"),
                EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_MAX_MESSAGES_TYPE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Basic", null));
    }
    ...
    protected void addCompletionMinMessagesValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description",
                        "_UI_AggregateMediator_completionMinMessagesValue_feature", "_UI_AggregateMediator_type"),
                EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_MIN_MESSAGES_VALUE, true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, "Basic", null));
    }
    ...
    protected void addCompletionMaxMessagesValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description",
                        "_UI_AggregateMediator_completionMaxMessagesValue_feature", "_UI_AggregateMediator_type"),
                EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_MAX_MESSAGES_VALUE, true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, "Basic", null));
    }
    ...
    protected void addCompletionMinMessagesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AggregateMediator_completionMinMessages_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_AggregateMediator_completionMinMessages_feature", "_UI_AggregateMediator_type"),
                        EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_MIN_MESSAGES_EXPRESSION, true, false, false,
                        ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, "Basic", null));
    }
    ...
    protected void addCompletionMaxMessagesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AggregateMediator_completionMaxMessages_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_AggregateMediator_completionMaxMessages_feature", "_UI_AggregateMediator_type"),
                        EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_MAX_MESSAGES_EXPRESSION, true, false, false,
                        ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, "Basic", null));
    }
