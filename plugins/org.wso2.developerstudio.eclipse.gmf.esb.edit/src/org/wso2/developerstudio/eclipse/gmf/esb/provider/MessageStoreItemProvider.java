 ...
 * @generated
 */
public class MessageStoreItemProvider extends EsbElementItemProvider {
    /**
    ...
    protected void addEnableProducerGuaranteedDeliveryPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_enableProducerGuaranteedDelivery_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_MessageStore_enableProducerGuaranteedDelivery_feature", "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__ENABLE_PRODUCER_GUARANTEED_DELIVERY, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, "Guaranteed Delivery Parameters", null));
    }
    ...
    protected void addFailoverMessageStorePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_failoverMessageStore_feature",
                        "_UI_MessageStore_type"),
                EsbPackage.Literals.MESSAGE_STORE__FAILOVER_MESSAGE_STORE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Guaranteed Delivery Parameters", null));
    }
    ...
    protected void addResequencepollingPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_resequencepolling_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequencepolling_feature",
                                "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__RESEQUENCEPOLLING, true, false, false,
    ...
    protected void addResequenceDatabaseTablePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequenceDatabaseTable_feature",
                        "_UI_MessageStore_type"),
                EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_DATABASE_TABLE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addResequenceConnectionInformationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_resequenceConnectionInformation_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_MessageStore_resequenceConnectionInformation_feature", "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_CONNECTION_INFORMATION, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addResequenceDriverPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_resequenceDriver_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequenceDriver_feature",
                                "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_DRIVER, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addResequenceURLPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_resequenceURL_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequenceURL_feature",
                                "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_URL, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addResequenceUserPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_resequenceUser_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequenceUser_feature",
                                "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_USER, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addResequencePasswordPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_resequencePassword_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequencePassword_feature",
                                "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_PASSWORD, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addResequenceDatasourceNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequenceDatasourceName_feature",
                        "_UI_MessageStore_type"),
                EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_DATASOURCE_NAME, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addResequenceXpathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_resequenceXpath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequenceXpath_feature",
                                "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_XPATH, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addResequenceXpathAttrPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_MessageStore_resequenceXpathAttr_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_MessageStore_resequenceXpathAttr_feature",
                                "_UI_MessageStore_type"),
                        EsbPackage.Literals.MESSAGE_STORE__RESEQUENCE_XPATH_ATTR, true, false, true, null, null, null));
    }
