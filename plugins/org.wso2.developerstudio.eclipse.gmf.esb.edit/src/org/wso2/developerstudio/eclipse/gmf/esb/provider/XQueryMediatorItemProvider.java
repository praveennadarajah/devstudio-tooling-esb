    ...
    protected void addQueryKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_XQueryMediator_queryKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_XQueryMediator_queryKey_feature",
                                "_UI_XQueryMediator_type"),
                        EsbPackage.Literals.XQUERY_MEDIATOR__QUERY_KEY, true, false, true, null, null, null));
    }
