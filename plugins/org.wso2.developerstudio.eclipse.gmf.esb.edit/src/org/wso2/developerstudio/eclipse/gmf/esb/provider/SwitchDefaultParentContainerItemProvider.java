...
public class SwitchDefaultParentContainerItemProvider extends EsbNodeItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.SWITCH_DEFAULT_PARENT_CONTAINER__SWITCH_DEFAULT_CONTAINER);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SwitchDefaultParentContainer"));
	}
    ...
    public String getText(Object object) {
		return getString("_UI_SwitchDefaultParentContainer_type");
	}
