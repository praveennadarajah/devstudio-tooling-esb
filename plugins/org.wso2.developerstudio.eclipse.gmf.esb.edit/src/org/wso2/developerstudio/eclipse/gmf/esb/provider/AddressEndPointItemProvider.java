    ...
    protected void addURIPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AddressEndPoint_URI_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AddressEndPoint_URI_feature",
                                "_UI_AddressEndPoint_type"),
                        EsbPackage.Literals.ADDRESS_END_POINT__URI, true, false, false,
