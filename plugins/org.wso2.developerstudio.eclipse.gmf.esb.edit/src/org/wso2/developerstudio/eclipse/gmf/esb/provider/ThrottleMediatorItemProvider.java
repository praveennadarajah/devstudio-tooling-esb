...
public class ThrottleMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addGroupIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottleMediator_groupId_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ThrottleMediator_groupId_feature",
                                "_UI_ThrottleMediator_type"),
                        EsbPackage.Literals.THROTTLE_MEDIATOR__GROUP_ID, true, false, false,
    ...
    protected void addPolicyTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottleMediator_policyType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ThrottleMediator_policyType_feature",
                                "_UI_ThrottleMediator_type"),
                        EsbPackage.Literals.THROTTLE_MEDIATOR__POLICY_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "Throttle Policy", null));
    }
    ...
    protected void addMaxConcurrentAccessCountPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottleMediator_maxConcurrentAccessCount_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ThrottleMediator_maxConcurrentAccessCount_feature", "_UI_ThrottleMediator_type"),
                        EsbPackage.Literals.THROTTLE_MEDIATOR__MAX_CONCURRENT_ACCESS_COUNT, true, false, false,
    ...
    protected void addPolicyEntriesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottleMediator_policyEntries_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ThrottleMediator_policyEntries_feature",
                                "_UI_ThrottleMediator_type"),
                        EsbPackage.Literals.THROTTLE_MEDIATOR__POLICY_ENTRIES, true, false, false, null,
    ...
    protected void addOnAcceptBranchsequenceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottleMediator_OnAcceptBranchsequenceType_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ThrottleMediator_OnAcceptBranchsequenceType_feature", "_UI_ThrottleMediator_type"),
                        EsbPackage.Literals.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCHSEQUENCE_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "On Acceptance", null));
    }
    ...
    protected void addOnAcceptBranchsequenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottleMediator_OnAcceptBranchsequenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ThrottleMediator_OnAcceptBranchsequenceKey_feature", "_UI_ThrottleMediator_type"),
                        EsbPackage.Literals.THROTTLE_MEDIATOR__ON_ACCEPT_BRANCHSEQUENCE_KEY, true, false, false, null,
                        "On Acceptance", null));
    }
    ...
    protected void addOnRejectBranchsequenceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottleMediator_OnRejectBranchsequenceType_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ThrottleMediator_OnRejectBranchsequenceType_feature", "_UI_ThrottleMediator_type"),
                        EsbPackage.Literals.THROTTLE_MEDIATOR__ON_REJECT_BRANCHSEQUENCE_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, "On Rejection", null));
    }
    ...
    protected void addOnRejectBranchsequenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottleMediator_OnRejectBranchsequenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ThrottleMediator_OnRejectBranchsequenceKey_feature", "_UI_ThrottleMediator_type"),
                        EsbPackage.Literals.THROTTLE_MEDIATOR__ON_REJECT_BRANCHSEQUENCE_KEY, true, false, false, null,
                        "On Rejection", null));
    }
    ...
    protected void addPolicyKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_ThrottlePolicyConfiguration_policyKey_feature",
                        "_UI_ThrottlePolicyConfiguration_type"),
                EsbPackage.Literals.THROTTLE_MEDIATOR__POLICY_KEY, true, false, false, null, "Throttle Policy", null));
    }
