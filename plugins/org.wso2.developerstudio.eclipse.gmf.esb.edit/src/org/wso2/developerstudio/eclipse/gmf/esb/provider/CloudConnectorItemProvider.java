...
public class CloudConnectorItemProvider extends EsbElementItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.CLOUD_CONNECTOR__INPUT_CONNECTOR);
			childrenFeatures.add(EsbPackage.Literals.CLOUD_CONNECTOR__OUTPUT_CONNECTOR);
			childrenFeatures.add(EsbPackage.Literals.CLOUD_CONNECTOR__CONNECTOR_PARAMETERS);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CloudConnector"));
	}
