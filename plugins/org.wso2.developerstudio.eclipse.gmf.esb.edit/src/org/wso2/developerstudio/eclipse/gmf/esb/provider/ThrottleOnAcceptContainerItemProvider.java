...
public class ThrottleOnAcceptContainerItemProvider extends EsbNodeItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.THROTTLE_ON_ACCEPT_CONTAINER__MEDIATOR_FLOW);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ThrottleOnAcceptContainer"));
	}
    ...
    public String getText(Object object) {
		return getString("_UI_ThrottleOnAcceptContainer_type");
	}
