 ...
 * @generated
 */
public class SynapseAPIAPICompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getSynapseAPIAPICompartment_7044SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return APIResourceEditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getSynapseAPIAPICompartment_7044SemanticChildren((View) getHost().getModel());
