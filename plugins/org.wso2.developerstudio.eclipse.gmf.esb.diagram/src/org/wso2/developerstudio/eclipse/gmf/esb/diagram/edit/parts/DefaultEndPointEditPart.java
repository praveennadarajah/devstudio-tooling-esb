...
public class DefaultEndPointEditPart extends AbstractEndpoint {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DefaultEndPointItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DefaultEndPointEndPointNameEditPart) {
			((DefaultEndPointEndPointNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureDefaultEndPointNamePropertyLabel());
			return true;
		}
		if (childEditPart instanceof DefaultEndPointInputConnectorEditPart) {
			...
			IFigure borderItemFigure = ((DefaultEndPointInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof DefaultEndPointOutputConnectorEditPart) {
			IFigure borderItemFigure = ((DefaultEndPointOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
					PositionConstants.WEST, 0.75);
			getBorderedFigure().getBorderItemContainer().add(borderItemFigure, locator);
			return true;
		}
		if (childEditPart instanceof DefaultEndPointDescriptionEditPart) {
			((DefaultEndPointDescriptionEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(DefaultEndPointEndPointNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class DefaultEndPointFigure extends EsbGraphicalShapeWithLabel {
