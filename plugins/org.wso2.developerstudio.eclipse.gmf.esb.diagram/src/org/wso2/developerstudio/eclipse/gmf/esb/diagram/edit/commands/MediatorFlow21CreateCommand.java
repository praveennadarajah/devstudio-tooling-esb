 ...
 * @generated
 */
public class MediatorFlow21CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow21CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		EntitlementOnRejectContainer container = (EntitlementOnRejectContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		EntitlementOnRejectContainer owner = (EntitlementOnRejectContainer) getElementToEdit();
