...
public class MediatorFlow5EditPart extends AbstractMediatorFlowEditPart {
	...
	public void refreshConnector(EditPart childEditPart) {
		if (childEditPart instanceof AbstractSequencesEditPart) {
			...
			sequencesEditPart.getBorderedFigure().getBorderItemContainer().add(sequencesEditPart.outputConnectorFigure,
					outputLocator);
			...
			sequencesEditPart.getBorderedFigure().getBorderItemContainer().add(sequencesEditPart.inputConnectorFigure,
					inputLocator);
		} else {
	...
	public class MediatorFlowFigure extends RoundedRectangle {
		...
		public MediatorFlowFigure() {
			...
			topRectangle.setBackgroundColor(new Color(null, 40, 40, 40));
			topRectangle.setPreferredSize(new Dimension(195, 4));
