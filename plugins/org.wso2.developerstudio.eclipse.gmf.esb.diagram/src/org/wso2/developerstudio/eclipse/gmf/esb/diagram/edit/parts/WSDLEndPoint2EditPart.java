	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WSDLEndPointEndPointName2EditPart) {
			((WSDLEndPointEndPointName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureWSDLEndPointNamePropertyLabel());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WSDLEndPointInputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((WSDLEndPointInputConnector2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof WSDLEndPointOutputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((WSDLEndPointOutputConnector2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
