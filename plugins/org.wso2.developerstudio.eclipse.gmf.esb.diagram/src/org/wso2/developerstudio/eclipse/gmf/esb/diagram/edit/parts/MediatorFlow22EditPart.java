 ...
 * @generated NOT
 */
public class MediatorFlow22EditPart extends AbstractMediatorFlowEditPart {
	...
	public void refreshOutputConnector(EditPart childEditPart) {
		if (childEditPart instanceof EntitlementMediatorEditPart) {
			...
			BorderItemLocator locator = new FixedBorderItemLocator(this.getFigure(),
					entitlementMediatorEditPart.onAcceptOutputConnector, PositionConstants.WEST, 0.5);
			entitlementMediatorEditPart.getBorderedFigure().getBorderItemContainer()
					.add(entitlementMediatorEditPart.onAcceptOutputConnector, locator);
		} else {
	...
	protected void addChildVisual(EditPart childEditPart, int index) {
		refreshOutputConnector(
				((EntitlementMediatorEditPart) childEditPart.getParent().getParent().getParent().getParent()));
	...
	public class MediatorFlowFigure extends EsbMediatorFlowFigure {
		...
		public MediatorFlowFigure() {
			...
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(20000), getMapMode().DPtoLP(4000)));
		}
