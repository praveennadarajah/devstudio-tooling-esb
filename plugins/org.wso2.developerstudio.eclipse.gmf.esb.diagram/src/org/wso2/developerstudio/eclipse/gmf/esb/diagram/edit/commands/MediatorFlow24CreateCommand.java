 ...
 * @generated
 */
public class MediatorFlow24CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow24CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		EntitlementObligationsContainer container = (EntitlementObligationsContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		EntitlementObligationsContainer owner = (EntitlementObligationsContainer) getElementToEdit();
