 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfPropertyGroupMediatorInputConnectorEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((PropertyGroupMediatorInputConnectorEditPart) targetEditPart);
	}
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((PropertyGroupMediatorInputConnectorEditPart) targetEditPart, relationshipType);
	}
