 ...
 * @generated
 */
public class ForEachMediatorInputConnectorCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ForEachMediatorInputConnectorCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		ForEachMediatorInputConnector newElement = EsbFactory.eINSTANCE.createForEachMediatorInputConnector();
	 ...
	 * @generated
	 */
	protected void doConfigure(ForEachMediatorInputConnector newElement, IProgressMonitor monitor, IAdaptable info)
