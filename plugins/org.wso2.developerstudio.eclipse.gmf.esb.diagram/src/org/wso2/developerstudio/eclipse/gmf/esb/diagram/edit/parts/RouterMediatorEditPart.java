...
public class RouterMediatorEditPart extends complexFiguredAbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RouterMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure = ((RouterMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
		...
		if (childEditPart instanceof RouterMediatorTargetOutputConnectorEditPart) {
			IFigure targetOutputConnector = ((RouterMediatorTargetOutputConnectorEditPart) childEditPart).getFigure();
	...
	public class RouterMediatorFigure extends CloneMediatorGraphicalShape {
		...
		private void createContents() {
			...
			fFigureRouterMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
