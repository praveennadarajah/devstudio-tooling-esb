 ...
 * @generated
 */
public class FailoverEndPointEndPointName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.FailoverEndPoint_3649, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FailoverEndPointEndPointName2EditPart.VISUAL_ID));
		}
		return parser;
	}
 ...
 * FailoverEndPointEndPointName2EditPart.VISUAL_ID));
 * }
 * return parser;
 * }
 * 
