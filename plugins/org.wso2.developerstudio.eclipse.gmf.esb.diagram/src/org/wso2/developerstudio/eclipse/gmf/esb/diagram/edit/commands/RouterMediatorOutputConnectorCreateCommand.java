 ...
 * @generated
 */
public class RouterMediatorOutputConnectorCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public RouterMediatorOutputConnectorCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		RouterMediatorOutputConnector newElement = EsbFactory.eINSTANCE.createRouterMediatorOutputConnector();
	 ...
	 * @generated
	 */
	protected void doConfigure(RouterMediatorOutputConnector newElement, IProgressMonitor monitor, IAdaptable info)
