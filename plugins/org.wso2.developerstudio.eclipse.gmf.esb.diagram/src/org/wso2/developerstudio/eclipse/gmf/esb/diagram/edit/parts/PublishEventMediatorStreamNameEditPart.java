 ...
 * @generated
 */
public class PublishEventMediatorStreamNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PublishEventMediatorStreamNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.PublishEventMediator_3785, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.PublishEventMediatorStreamNameEditPart.VISUAL_ID));
		}
		return parser;
	}
