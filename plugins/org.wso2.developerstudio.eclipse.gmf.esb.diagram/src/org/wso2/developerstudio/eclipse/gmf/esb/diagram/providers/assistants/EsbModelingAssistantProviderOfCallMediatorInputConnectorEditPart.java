 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfCallMediatorInputConnectorEditPart extends EsbModelingAssistantProvider {
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((CallMediatorInputConnectorEditPart) targetEditPart);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnTarget(CallMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((CallMediatorInputConnectorEditPart) targetEditPart, relationshipType);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetTypesForSource(CallMediatorInputConnectorEditPart target,
