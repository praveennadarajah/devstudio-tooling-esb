 ...
 * @generated
 */
public class MediatorFlow9CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow9CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		ThrottleOnAcceptContainer container = (ThrottleOnAcceptContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ThrottleOnAcceptContainer owner = (ThrottleOnAcceptContainer) getElementToEdit();
