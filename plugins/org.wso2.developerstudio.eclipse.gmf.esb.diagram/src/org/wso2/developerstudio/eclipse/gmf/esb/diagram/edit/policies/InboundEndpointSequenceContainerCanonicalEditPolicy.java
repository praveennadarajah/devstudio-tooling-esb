 ...
 * @generated
 */
public class InboundEndpointSequenceContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE.getInboundEndpointSequenceContainer_MediatorFlow();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getInboundEndpointSequenceContainer_3773SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow25EditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getInboundEndpointSequenceContainer_3773SemanticChildren((View) getHost().getModel());
