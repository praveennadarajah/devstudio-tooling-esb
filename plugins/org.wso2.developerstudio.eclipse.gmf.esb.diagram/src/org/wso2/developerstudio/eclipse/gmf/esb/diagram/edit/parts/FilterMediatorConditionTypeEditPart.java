 ...
 * @generated
 */
public class FilterMediatorConditionTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.FilterMediator_3494, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FilterMediatorConditionTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, EsbEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
