 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfPublishEventMediatorOutputConnectorEditPart
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((PublishEventMediatorOutputConnectorEditPart) sourceEditPart);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnSource(PublishEventMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((PublishEventMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnSourceAndTarget(PublishEventMediatorOutputConnectorEditPart source,
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((PublishEventMediatorOutputConnectorEditPart) sourceEditPart, relationshipType);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetTypesForTarget(PublishEventMediatorOutputConnectorEditPart source,
