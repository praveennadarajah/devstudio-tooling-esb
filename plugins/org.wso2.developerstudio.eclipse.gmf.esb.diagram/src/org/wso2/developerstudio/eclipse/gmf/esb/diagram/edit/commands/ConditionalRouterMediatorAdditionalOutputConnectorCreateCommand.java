 ...
 * @generated
 */
public class ConditionalRouterMediatorAdditionalOutputConnectorCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (container.getAdditionalOutputConnector() != null) {
			return false;
		}
		return true;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		owner.setAdditionalOutputConnector(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(ConditionalRouterMediatorAdditionalOutputConnector newElement, IProgressMonitor monitor,
