...
public class InboundEndpointOnErrorSequenceContainerCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		InboundEndpointContainer container = (InboundEndpointContainer) getElementToEdit();
		if (container.getOnErrorSequenceContainer() != null) {
			return false;
		}
		return true;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		owner.setOnErrorSequenceContainer(newElement);
