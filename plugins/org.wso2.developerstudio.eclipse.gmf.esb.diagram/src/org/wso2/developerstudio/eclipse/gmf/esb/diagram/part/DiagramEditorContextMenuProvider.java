...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.custom.configure.LoadParametersFromSchemaAction;
...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		...
		contextActions.put(CloudConnectorOperation.class, new LoadParametersFromSchemaAction(part));
						...
						public void run() {
							...
							if (selectedEPs.size() == 1) {
								...
								if (contextObj instanceof EObject) {
									...
									menu.appendToGroup(ESB_DEBUGGER_ACTIONS_MENU_GROUP, new ESBBreakpointAction(part));
									menu.appendToGroup(ESB_DEBUGGER_ACTIONS_MENU_GROUP, new ESBSkipPointAction(part));
									menu.appendToGroup(ESB_DEBUGGER_ACTIONS_MENU_GROUP,
											new ESBBreakpointRePopulateAction(part));
									menu.appendToGroup(ESB_DEBUGGER_ACTIONS_MENU_GROUP,
											new ESBBreakpointDeleteAllAction(part));
									menu.appendToGroup(ESB_DEBUGGER_ACTIONS_MENU_GROUP,
