 ...
 * @generated
 */
public class RouterMediatorContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE.getRouterMediatorContainer_RouterTargetContainer();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getRouterMediatorContainer_3632SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return RouterTargetContainerEditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getRouterMediatorContainer_3632SemanticChildren((View) getHost().getModel());
