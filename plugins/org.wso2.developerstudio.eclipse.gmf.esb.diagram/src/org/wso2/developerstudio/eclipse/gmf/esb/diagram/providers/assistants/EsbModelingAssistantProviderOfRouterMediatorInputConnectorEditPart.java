 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfRouterMediatorInputConnectorEditPart extends EsbModelingAssistantProvider {
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((RouterMediatorInputConnectorEditPart) targetEditPart);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnTarget(RouterMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((RouterMediatorInputConnectorEditPart) targetEditPart, relationshipType);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetTypesForSource(RouterMediatorInputConnectorEditPart target,
