...
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.OAUTH_MEDIATOR_ICON_PATH;
...
public class OAuthMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new OAuthMediatorFigure(new Color(null, 53, 73, 94)) {
