 ...
 * @generated
 */
public class ConditionalRouterMediatorOutputConnectorCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ConditionalRouterMediatorOutputConnectorCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		ConditionalRouterMediatorOutputConnector newElement = EsbFactory.eINSTANCE
				.createConditionalRouterMediatorOutputConnector();
	 ...
	 * @generated
	 */
	protected void doConfigure(ConditionalRouterMediatorOutputConnector newElement, IProgressMonitor monitor,
