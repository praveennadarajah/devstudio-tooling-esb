 ...
 * @generated NOT
 */
public class MediatorFlow16EditPart extends AbstractMediatorFlowEditPart {
	...
	public void refreshOutputConnector(EditPart childEditPart) {
		if (childEditPart instanceof ConditionalRouterMediatorEditPart) {
			...
			BorderItemLocator locator = new FixedBorderItemLocator(this.getFigure(),
					conditionalRouterMediatorEditPart.additionalOutputConnector, PositionConstants.WEST, 0.5);
	...
	protected void addChildVisual(EditPart childEditPart, int index) {
		refreshOutputConnector(((ConditionalRouterMediatorEditPart) childEditPart.getParent().getParent()));
	...
	public class MediatorFlowFigure extends EsbMediatorFlowFigure {
		...
		public MediatorFlowFigure() {
			...
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(5000), getMapMode().DPtoLP(4000)));
		}
	...
	public AbstractOutputConnectorEditPart getAssociatedOutputConnector() {
		return EditorUtils.getOutputConnector((ShapeNodeEditPart) this.getParent(),
				ConditionalRouterMediatorAdditionalOutputConnectorEditPart.class);
	}
