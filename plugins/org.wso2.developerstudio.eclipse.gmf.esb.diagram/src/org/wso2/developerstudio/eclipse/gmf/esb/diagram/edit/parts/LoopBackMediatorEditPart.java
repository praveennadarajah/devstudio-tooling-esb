...
public class LoopBackMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new LoopBackMediatorFigure(new Color(null, 41, 128, 185)) {
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LoopBackMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((LoopBackMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof LoopBackMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((LoopBackMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public class LoopBackMediatorFigure extends EsbGraphicalShapeWithLabel {
		...
		private void createContents() {
			...
			fFigureLoopBackMediatorDescriptionFigure.setText(DEFAULT_PROPERTY_VALUE_TEXT);
		...
		public IFigure getToolTip() {
			if (StringUtils.isEmpty(toolTipMessage)) {
				toolTipMessage = Messages.LoopBackMediatorEditPart_ToolTipMessage;
			}
