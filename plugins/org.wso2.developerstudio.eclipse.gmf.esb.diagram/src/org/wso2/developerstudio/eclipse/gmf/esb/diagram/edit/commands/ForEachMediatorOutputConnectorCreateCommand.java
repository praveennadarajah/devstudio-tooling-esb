 ...
 * @generated
 */
public class ForEachMediatorOutputConnectorCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ForEachMediatorOutputConnectorCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		ForEachMediatorOutputConnector newElement = EsbFactory.eINSTANCE.createForEachMediatorOutputConnector();
	 ...
	 * @generated
	 */
	protected void doConfigure(ForEachMediatorOutputConnector newElement, IProgressMonitor monitor, IAdaptable info)
