 ...
 * @generated
 */
public class EntitlementOnAcceptContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE.getEntitlementOnAcceptContainer_MediatorFlow();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEntitlementOnAcceptContainer_3755SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow22EditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEntitlementOnAcceptContainer_3755SemanticChildren((View) getHost().getModel());
