...
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.DBLOOKUP_MEDIATOR_ICON_PATH;
...
public class DBLookupMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new DBLookupMediatorFigure(new Color(null, 121, 86, 73)) {
    ...
    public void notifyChanged(Notification notification) {
        ...
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof DBLookupMediatorImpl) {
                ...
                try {
                    org.apache.synapse.mediators.db.DBLookupMediator dbLookupMediator = DBLookupMediatorTransformer
                            .createDBLookupMediator(new TransformationInfo(), (EsbNode) dbLookupMediatorDataModel);

                    DBLookupMediatorSerializer dbLookupMediatorSerializer = new DBLookupMediatorSerializer();
                    OMElement omElement = dbLookupMediatorSerializer.serializeSpecificMediator(dbLookupMediator);

                    if (StringUtils
                            .isEmpty(MediatorValidationUtil.validateMediatorsFromOEMElement(omElement, "dblookup"))) {
