 ...
 * @generated
 */
public class SwitchCaseParentContainerItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SwitchCaseParentContainerItemSemanticEditPolicy() {
		super(EsbElementTypes.SwitchCaseParentContainer_3732);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SwitchCaseContainer_3733 == req.getElementType()) {
