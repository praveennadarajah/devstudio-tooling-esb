...
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.RMSEQEUENCE_MEDIATOR_ICON_PATH;
...
public class RMSequenceMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RMSequenceMediatorDescriptionEditPart) {
			((RMSequenceMediatorDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getRMSequenceMediatorDescriptionLabel());
			return true;
		}
	...
	public class RMSequenceMediatorFigure extends EsbGraphicalShapeWithLabel {
		...
		private void createContents() {
			...
			fFigureRMSequenceMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
		...
		public String getIconPath() {
			return RMSEQEUENCE_MEDIATOR_ICON_PATH;
		}
		...
		public IFigure getToolTip() {
			if (StringUtils.isEmpty(toolTipMessage)) {
				toolTipMessage = Messages.RMSequenceMediatorEditPart_ToolTipMessage;
			}
