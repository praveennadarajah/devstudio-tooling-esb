 ...
 * @generated
 */
public class MediatorFlow7CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow7CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		FilterPassContainer container = (FilterPassContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		FilterPassContainer owner = (FilterPassContainer) getElementToEdit();
