 ...
 * @generated NOT
 */
public class FailoverEndPointInputConnector2EditPart extends AbstractEndpointInputConnectorEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new FailoverEndPointInputConnector2ItemSemanticEditPolicy());
