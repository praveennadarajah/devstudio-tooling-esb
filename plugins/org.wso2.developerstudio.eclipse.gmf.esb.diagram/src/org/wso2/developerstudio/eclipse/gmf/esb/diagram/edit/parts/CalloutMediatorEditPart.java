...
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.CALLOUT_MEDIATOR_ICON_PATH;
...
import org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl;
...
public class CalloutMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CalloutMediatorFigure(new Color(null, 208, 67, 0)) {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CalloutMediatorSoapActionEditPart) {
			((CalloutMediatorSoapActionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCalloutMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof CalloutMediatorDescriptionEditPart) {
			((CalloutMediatorDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getCalloutMediatorDescriptionLabel());
			return true;
		}
	...
	public class CalloutMediatorFigure extends EsbGraphicalShapeWithLabel {
		...
		private void createContents() {
			...
			fFigureCalloutMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
		...
		public String getIconPath() {
			return CALLOUT_MEDIATOR_ICON_PATH;
		}
		...
		public IFigure getToolTip() {
			if (StringUtils.isEmpty(toolTipMessage)) {
				toolTipMessage = Messages.CalloutMediatorEditPart_ToolTipMessage;
			}
