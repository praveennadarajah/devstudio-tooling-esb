 ...
 * @generated
 */
public class PropertyMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
		...
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.PropertyMediator_3492, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.PropertyMediatorDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
