...
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.BUILDER_MEDIATOR_ICON_PATH;
...
import org.wso2.carbon.relay.mediators.builder.xml.BuilderMediatorSerializer;
...
import org.wso2.developerstudio.eclipse.gmf.esb.impl.BuilderMediatorImpl;
...
public class BuilderMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new BuilderMediatorFigure(new Color(null, 121, 86, 73)) {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BuilderMediatorDescriptionEditPart) {
			((BuilderMediatorDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getBuilderDescriptionLabel());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BuilderMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((BuilderMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BuilderMediatorOutputConectorEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((BuilderMediatorOutputConectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public class BuilderMediatorFigure extends EsbGraphicalShapeWithLabel {
		...
		private void createContents() {
			...
			fFigureBuilderMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
		...
		public String getIconPath() {
			return BUILDER_MEDIATOR_ICON_PATH;
		}
		...
		public IFigure getToolTip() {
			if (StringUtils.isEmpty(toolTipMessage)) {
				toolTipMessage = Messages.BuilderMediatorEditPart_ToolTipMessage;
			}
