 ...
 * @generated
 */
public class DataMapperMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataMapperMediatorDescriptionEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.DataMapperMediator_3761, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DataMapperMediatorDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
