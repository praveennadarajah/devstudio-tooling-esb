 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfCallTemplateMediatorOutputConnectorEditPart
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((CallTemplateMediatorOutputConnectorEditPart) sourceEditPart);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnSource(CallTemplateMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((CallTemplateMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnSourceAndTarget(CallTemplateMediatorOutputConnectorEditPart source,
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((CallTemplateMediatorOutputConnectorEditPart) sourceEditPart, relationshipType);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetTypesForTarget(CallTemplateMediatorOutputConnectorEditPart source,
