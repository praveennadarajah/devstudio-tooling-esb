 ...
 * @generated
 */
public class TemplateEndpointDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TemplateEndpointDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.TemplateEndpoint_3716, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.TemplateEndpointDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
