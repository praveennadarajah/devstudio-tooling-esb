 ...
 * @generated
 */
public class CloneMediatorContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getCloneMediatorContainer_3603SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return CloneTargetContainerEditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getCloneMediatorContainer_3603SemanticChildren((View) getHost().getModel());
