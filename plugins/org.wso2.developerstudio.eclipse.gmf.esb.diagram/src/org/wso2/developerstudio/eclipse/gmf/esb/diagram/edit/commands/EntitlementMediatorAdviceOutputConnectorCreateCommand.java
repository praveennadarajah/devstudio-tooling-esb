...
public class EntitlementMediatorAdviceOutputConnectorCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (container.getAdviceOutputConnector() != null) {
			return false;
		}
		return true;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		owner.setAdviceOutputConnector(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(EntitlementMediatorAdviceOutputConnector newElement, IProgressMonitor monitor,
