...
public class LoadBalanceEndPointEditPart extends ComplexFiguredAbstractEndpoint {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LoadBalanceEndPointItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LoadBalanceEndPointCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LoadBalanceEndPointEndPointNameEditPart) {
			((LoadBalanceEndPointEndPointNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureLoadBalanceEndPointNamePropertyLabel());
			return true;
		}
		if (childEditPart instanceof LoadBalanceEndPointInputConnectorEditPart) {
			...
			IFigure borderItemFigure = ((LoadBalanceEndPointInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof LoadBalanceEndPointWestOutputConnectorEditPart) {
			IFigure borderItemFigure = ((LoadBalanceEndPointWestOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
		...
		if (childEditPart instanceof LoadBalanceEndPointDescriptionEditPart) {
			((LoadBalanceEndPointDescriptionEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EsbVisualIDRegistry.getType(LoadBalanceEndPointEndPointNameEditPart.VISUAL_ID));
	}
