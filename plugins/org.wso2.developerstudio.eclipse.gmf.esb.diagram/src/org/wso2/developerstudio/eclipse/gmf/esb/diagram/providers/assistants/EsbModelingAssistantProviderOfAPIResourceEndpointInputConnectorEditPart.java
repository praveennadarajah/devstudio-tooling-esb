 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfAPIResourceEndpointInputConnectorEditPart
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((APIResourceEndpointInputConnectorEditPart) targetEditPart);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnTarget(APIResourceEndpointInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((APIResourceEndpointInputConnectorEditPart) targetEditPart, relationshipType);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetTypesForSource(APIResourceEndpointInputConnectorEditPart target,
