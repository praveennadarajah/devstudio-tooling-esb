 ...
 * @generated NOT
 */
public class APIResourceFaultInputConnectorEditPart extends AbstractBaseFigureFaultInputConnectorEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new APIResourceFaultInputConnectorItemSemanticEditPolicy());
			...
			if (sourceConnection instanceof AbstractOutputConnectorEditPart) {
				if (sourceConnection.getParent() instanceof EditPart) {
					...
					if (!(sourceConnection.getParent()
							.getParent() instanceof MediatorFlowMediatorFlowCompartment6EditPart)) {
