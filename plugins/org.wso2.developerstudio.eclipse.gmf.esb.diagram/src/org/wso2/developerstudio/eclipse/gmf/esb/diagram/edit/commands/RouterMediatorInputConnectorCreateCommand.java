 ...
 * @generated
 */
public class RouterMediatorInputConnectorCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public RouterMediatorInputConnectorCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		RouterMediatorInputConnector newElement = EsbFactory.eINSTANCE.createRouterMediatorInputConnector();
	 ...
	 * @generated
	 */
	protected void doConfigure(RouterMediatorInputConnector newElement, IProgressMonitor monitor, IAdaptable info)
