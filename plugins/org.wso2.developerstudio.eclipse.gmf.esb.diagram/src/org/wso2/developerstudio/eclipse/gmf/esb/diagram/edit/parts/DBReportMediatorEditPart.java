...
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.DBREPORT_MEDIATOR_ICON_PATH;
...
public class DBReportMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new DBReportMediatorFigure(new Color(null, 121, 86, 73)) {
