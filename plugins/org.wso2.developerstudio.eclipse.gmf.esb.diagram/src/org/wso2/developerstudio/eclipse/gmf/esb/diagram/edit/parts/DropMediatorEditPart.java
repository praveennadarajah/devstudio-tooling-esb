...
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.DROP_MEDIATOR_ICON_PATH;
...
public class DropMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DropMediatorFigure(new Color(null, 41, 128, 185)) {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DropMediatorDescriptionEditPart) {
			((DropMediatorDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getDropMediatorDescriptionLabel());
			return true;
		}
		return false;
	}
	...
	public class DropMediatorFigure extends EsbGraphicalShapeWithLabel {
		...
		private void createContents() {
			...
			fDropMediatorLabelFigure.setText(DEFAULT_PROPERTY_VALUE_TEXT);
		...
		public String getIconPath() {
			return DROP_MEDIATOR_ICON_PATH;
		}
		...
		public IFigure getToolTip() {
			if (StringUtils.isEmpty(toolTipMessage)) {
				toolTipMessage = Messages.DropMediatorEditPart_ToolTipMessage;
			}
