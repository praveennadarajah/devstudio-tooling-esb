 ...
 * @generated
 */
public class SwitchDefaultParentContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE.getSwitchDefaultParentContainer_SwitchDefaultContainer();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getSwitchDefaultParentContainer_3734SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return SwitchDefaultContainerEditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getSwitchDefaultParentContainer_3734SemanticChildren((View) getHost().getModel());
