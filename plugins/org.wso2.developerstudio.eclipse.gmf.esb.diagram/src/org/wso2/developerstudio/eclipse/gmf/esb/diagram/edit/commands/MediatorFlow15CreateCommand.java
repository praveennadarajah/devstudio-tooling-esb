 ...
 * @generated
 */
public class MediatorFlow15CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow15CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		RouterTargetContainer container = (RouterTargetContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		RouterTargetContainer owner = (RouterTargetContainer) getElementToEdit();
