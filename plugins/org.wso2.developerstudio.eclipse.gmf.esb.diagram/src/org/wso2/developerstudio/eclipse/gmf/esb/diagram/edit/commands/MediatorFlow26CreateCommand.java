 ...
 * @generated
 */
public class MediatorFlow26CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow26CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		InboundEndpointOnErrorSequenceContainer container = (InboundEndpointOnErrorSequenceContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		InboundEndpointOnErrorSequenceContainer owner = (InboundEndpointOnErrorSequenceContainer) getElementToEdit();
