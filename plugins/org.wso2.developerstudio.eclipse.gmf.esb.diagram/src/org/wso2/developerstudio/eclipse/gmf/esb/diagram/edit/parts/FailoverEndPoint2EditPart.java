	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FailoverEndPointEndPointName2EditPart) {
			((FailoverEndPointEndPointName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFailoverEndPointNamePropertyLabel());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FailoverEndPointInputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((FailoverEndPointInputConnector2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof FailoverEndPointOutputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((FailoverEndPointOutputConnector2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof FailoverEndPointWestOutputConnector2EditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((FailoverEndPointWestOutputConnector2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
