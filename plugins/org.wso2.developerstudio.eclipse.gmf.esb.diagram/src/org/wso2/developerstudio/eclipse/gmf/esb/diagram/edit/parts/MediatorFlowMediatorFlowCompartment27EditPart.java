...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartment27CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartment27ItemSemanticEditPolicy;
...
public class MediatorFlowMediatorFlowCompartment27EditPart extends AbstractComplexEndpointCompartmentEditPart {
	 ...
	 * @generated
	 */
	public MediatorFlowMediatorFlowCompartment27EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.MediatorFlowMediatorFlowCompartment27EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MediatorFlowMediatorFlowCompartment27ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(EsbVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MediatorFlowMediatorFlowCompartment27CanonicalEditPolicy());
	}
	...
	protected void removeChild(EditPart child) {
		...
		if (((AbstractEndpoint) child).getTargetConnections().size() > 0) {

			OutputConnector outputConnector = ((EsbLink) ((Node) ((EsbLinkEditPart) EditorUtils
					.getInputConnector((AbstractEndpoint) child).getTargetConnections().get(0)).getModel())
