...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartment29CanonicalEditPolicy;
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartment29ItemSemanticEditPolicy;
...
public class MediatorFlowMediatorFlowCompartment29EditPart extends AbstractComplexEndpointCompartmentEditPart {
	 ...
	 * @generated
	 */
	public MediatorFlowMediatorFlowCompartment29EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MediatorFlowMediatorFlowCompartment29ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(EsbVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MediatorFlowMediatorFlowCompartment29CanonicalEditPolicy());
	}
	...
	private void addConnectorAndLink(EditPart child) {
		LoadBalanceEndPointOutputConnector connector = EsbFactory.eINSTANCE.createLoadBalanceEndPointOutputConnector();
		EditingDomain editingDomain = ((IGraphicalEditPart) child).getEditingDomain();
		AddCommand addCmd = new AddCommand(editingDomain, complexEndpoint,
