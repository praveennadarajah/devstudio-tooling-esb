 ...
 * @generated
 */
public class ProxyServiceSequenceAndEndpointContainerItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.MediatorFlow_3608 == req.getElementType()) {
