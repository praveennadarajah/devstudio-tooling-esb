 ...
 * @generated
 */
public class ProxyServiceSequenceAndEndpointContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE.getProxyServiceSequenceAndEndpointContainer_MediatorFlow();
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getProxyServiceSequenceAndEndpointContainer_3487SemanticChildren((View) getHost().getModel());
