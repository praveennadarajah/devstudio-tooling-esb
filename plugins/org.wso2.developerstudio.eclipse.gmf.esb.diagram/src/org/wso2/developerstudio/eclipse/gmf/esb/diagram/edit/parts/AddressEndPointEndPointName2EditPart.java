 ...
 * @generated
 */
public class AddressEndPointEndPointName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.AddressEndPoint_3646, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.AddressEndPointEndPointName2EditPart.VISUAL_ID));
		}
		return parser;
	}
 ...
 * AddressEndPointEndPointName2EditPart.VISUAL_ID));
 * }
 * return parser;
 * }
 * 
