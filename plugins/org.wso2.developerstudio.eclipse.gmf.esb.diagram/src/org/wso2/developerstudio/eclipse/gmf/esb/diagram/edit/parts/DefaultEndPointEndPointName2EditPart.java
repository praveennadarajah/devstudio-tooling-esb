 ...
 * @generated
 */
public class DefaultEndPointEndPointName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.DefaultEndPoint_3643, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DefaultEndPointEndPointName2EditPart.VISUAL_ID));
		}
		return parser;
	}
 ...
 * DefaultEndPointEndPointName2EditPart.VISUAL_ID));
 * }
 * return parser;
 * }
 * 
