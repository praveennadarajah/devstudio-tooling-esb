...
public class EsbVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case PropertyGroupMediatorEditPart.VISUAL_ID:
			if (EsbPackage.eINSTANCE.getPropertyGroupMediatorInputConnector().isSuperTypeOf(domainElement.eClass())) {
				return PropertyGroupMediatorInputConnectorEditPart.VISUAL_ID;
			}
			if (EsbPackage.eINSTANCE.getPropertyGroupMediatorOutputConnector().isSuperTypeOf(domainElement.eClass())) {
				return PropertyGroupMediatorOutputConnectorEditPart.VISUAL_ID;
			}
			break;
		case ThrottleMediatorEditPart.VISUAL_ID:
			...
			if (EsbPackage.eINSTANCE.getThrottleMediatorOnAcceptOutputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
				return ThrottleMediatorOnAcceptOutputConnectorEditPart.VISUAL_ID;
			}
			if (EsbPackage.eINSTANCE.getThrottleMediatorOnRejectOutputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
		...
		case EntitlementMediatorEditPart.VISUAL_ID:
			...
			if (EsbPackage.eINSTANCE.getEntitlementMediatorOnRejectOutputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
				return EntitlementMediatorOnRejectOutputConnectorEditPart.VISUAL_ID;
			}
			if (EsbPackage.eINSTANCE.getEntitlementMediatorOnAcceptOutputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
		...
		case RuleMediatorEditPart.VISUAL_ID:
			...
			if (EsbPackage.eINSTANCE.getRuleMediatorChildMediatorsOutputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
		...
		case ConditionalRouterMediatorEditPart.VISUAL_ID:
			if (EsbPackage.eINSTANCE.getConditionalRouterMediatorInputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
		...
		case CloudConnectorOperationEditPart.VISUAL_ID:
			...
			if (EsbPackage.eINSTANCE.getCloudConnectorOperationOutputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
		...
		case InboundEndpointEditPart.VISUAL_ID:
			...
			if (EsbPackage.eINSTANCE.getInboundEndpointSequenceOutputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
				return InboundEndpointSequenceOutputConnectorEditPart.VISUAL_ID;
			}
			if (EsbPackage.eINSTANCE.getInboundEndpointOnErrorSequenceInputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
				return InboundEndpointOnErrorSequenceInputConnectorEditPart.VISUAL_ID;
			}
			if (EsbPackage.eINSTANCE.getInboundEndpointOnErrorSequenceOutputConnector()
					.isSuperTypeOf(domainElement.eClass())) {
		...
		case InboundEndpointContainerEditPart.VISUAL_ID:
			...
			if (EsbPackage.eINSTANCE.getInboundEndpointOnErrorSequenceContainer()
					.isSuperTypeOf(domainElement.eClass())) {
		...
		case MediatorFlowMediatorFlowCompartmentEditPart.VISUAL_ID:
			...
			if (EsbPackage.eINSTANCE.getPropertyGroupMediator().isSuperTypeOf(domainElement.eClass())) {
				return PropertyGroupMediatorEditPart.VISUAL_ID;
			}
		...
		return getSubNodeVisualID(containerVisualID, domainElement);
	}
	
	public static int getSubNodeVisualID(int containerVisualID, EObject domainElement) {
	    switch (containerVisualID) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case PropertyMediatorEditPart.VISUAL_ID:
			...
			break;
		case PropertyGroupMediatorEditPart.VISUAL_ID:
			if (PropertyGroupMediatorDescriptionEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (PropertyGroupMediatorInputConnectorEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (PropertyGroupMediatorOutputConnectorEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ThrottleMediatorEditPart.VISUAL_ID:
		...
		case MediatorFlowMediatorFlowCompartmentEditPart.VISUAL_ID:
			...
			if (PropertyGroupMediatorEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
