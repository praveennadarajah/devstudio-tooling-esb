 ...
 * @generated
 */
public class EntitlementOnRejectContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE.getEntitlementOnRejectContainer_MediatorFlow();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEntitlementOnRejectContainer_3753SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow21EditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEntitlementOnRejectContainer_3753SemanticChildren((View) getHost().getModel());
