 ...
 * @generated
 */
public class ThrottleOnAcceptContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE.getThrottleOnAcceptContainer_MediatorFlow();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getThrottleOnAcceptContainer_3584SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow9EditPart.VISUAL_ID == EsbVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getThrottleOnAcceptContainer_3584SemanticChildren((View) getHost().getModel());
