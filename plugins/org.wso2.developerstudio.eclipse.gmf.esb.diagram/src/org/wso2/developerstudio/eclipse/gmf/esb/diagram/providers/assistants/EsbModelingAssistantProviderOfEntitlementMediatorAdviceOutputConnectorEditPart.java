 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfEntitlementMediatorAdviceOutputConnectorEditPart
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((EntitlementMediatorAdviceOutputConnectorEditPart) sourceEditPart);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnSource(EntitlementMediatorAdviceOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((EntitlementMediatorAdviceOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetRelTypesOnSourceAndTarget(EntitlementMediatorAdviceOutputConnectorEditPart source,
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((EntitlementMediatorAdviceOutputConnectorEditPart) sourceEditPart, relationshipType);
	}

	/**
	 * @generated
	 */
	public List<IElementType> doGetTypesForTarget(EntitlementMediatorAdviceOutputConnectorEditPart source,
