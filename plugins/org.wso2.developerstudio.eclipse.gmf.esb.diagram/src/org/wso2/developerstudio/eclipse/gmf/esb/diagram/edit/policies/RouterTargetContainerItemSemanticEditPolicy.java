...
import org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.commands.MediatorFlow15CreateCommand;
...
public class RouterTargetContainerItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
	 ...
	 * @generated
	 */
	public RouterTargetContainerItemSemanticEditPolicy() {
		super(EsbElementTypes.RouterTargetContainer_3633);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.MediatorFlow_3634 == req.getElementType()) {
			return getGEFWrapper(new MediatorFlow15CreateCommand(req));
		}
