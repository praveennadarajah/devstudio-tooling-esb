 ...
 * @generated
 */
public class WSDLEndPointEndPointName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.WSDLEndPoint_3653, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.WSDLEndPointEndPointName2EditPart.VISUAL_ID));
        }
        return parser;
    }
