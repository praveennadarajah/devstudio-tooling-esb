...
public class EsbDiagramUpdater {
	...
	*/
	 ...
	 * @generated
	 */
	public static List<EsbLinkDescriptor> getInboundEndpointOnErrorSequenceInputConnector_3770ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<EsbLinkDescriptor> getInboundEndpointOnErrorSequenceOutputConnector_3771ContainedLinks(
			View view) {
	...
	*/
	 ...
	 * @generated
	 */
	public static List<EsbLinkDescriptor> getEntitlementMediatorObligationsOutputConnector_3751ContainedLinks(
			View view) {
	 ...
	 * @generated
	 */
	public static List<EsbLinkDescriptor> getInboundEndpointOnErrorSequenceOutputConnector_3771IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	...
	*/
	 ...
	 * @generated
	 */
	public static List<EsbLinkDescriptor> getEntitlementMediatorObligationsOutputConnector_3751IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<EsbLinkDescriptor> getInboundEndpointOnErrorSequenceOutputConnector_3771OutgoingLinks(
			View view) {
		InboundEndpointOnErrorSequenceOutputConnector modelElement = (InboundEndpointOnErrorSequenceOutputConnector) view
				.getElement();
		LinkedList<EsbLinkDescriptor> result = new LinkedList<EsbLinkDescriptor>();
	...
	*/
	 ...
	 * @generated
	 */
	public static List<EsbLinkDescriptor> getEntitlementMediatorObligationsOutputConnector_3751OutgoingLinks(
			View view) {
		EntitlementMediatorObligationsOutputConnector modelElement = (EntitlementMediatorObligationsOutputConnector) view
				.getElement();
		LinkedList<EsbLinkDescriptor> result = new LinkedList<EsbLinkDescriptor>();
	...
	private static Collection<EsbLinkDescriptor> getIncomingTypeModelFacetLinks_EsbLink_4001(InputConnector target,
		...
		for (EStructuralFeature.Setting setting : settings) {
			...
			OutputConnector src = link.getSource();
			result.add(
					new EsbLinkDescriptor(src, target, link, EsbElementTypes.EsbLink_4001, EsbLinkEditPart.VISUAL_ID));
		}
		return result;
	}
