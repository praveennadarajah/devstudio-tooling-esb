 ...
 * @generated
 */
public class MediatorFlow8CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow8CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		FilterFailContainer container = (FilterFailContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		FilterFailContainer owner = (FilterFailContainer) getElementToEdit();
