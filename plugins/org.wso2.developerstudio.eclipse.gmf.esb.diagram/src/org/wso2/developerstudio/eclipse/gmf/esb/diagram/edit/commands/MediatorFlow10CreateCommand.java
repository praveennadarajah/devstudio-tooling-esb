 ...
 * @generated
 */
public class MediatorFlow10CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow10CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		ThrottleOnRejectContainer container = (ThrottleOnRejectContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ThrottleOnRejectContainer owner = (ThrottleOnRejectContainer) getElementToEdit();
