 ...
 * @generated
 */
public class MediatorFlow23CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow23CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		EntitlementAdviceContainer container = (EntitlementAdviceContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		EntitlementAdviceContainer owner = (EntitlementAdviceContainer) getElementToEdit();
