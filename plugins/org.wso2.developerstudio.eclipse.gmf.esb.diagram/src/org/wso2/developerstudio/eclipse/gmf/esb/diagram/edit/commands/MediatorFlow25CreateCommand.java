 ...
 * @generated
 */
public class MediatorFlow25CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow25CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		InboundEndpointSequenceContainer container = (InboundEndpointSequenceContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		InboundEndpointSequenceContainer owner = (InboundEndpointSequenceContainer) getElementToEdit();
