 ...
 * @generated
 */
public class MediatorFlow22CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public MediatorFlow22CreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		EntitlementOnAcceptContainer container = (EntitlementOnAcceptContainer) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		EntitlementOnAcceptContainer owner = (EntitlementOnAcceptContainer) getElementToEdit();
