 ...
 * @generated
 */
public class FaultMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
		...
		if (parser == null) {
			parser = EsbParserProvider.getParser(EsbElementTypes.FaultMediator_3509, getParserElement(),
					EsbVisualIDRegistry.getType(
							org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FaultMediatorDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
