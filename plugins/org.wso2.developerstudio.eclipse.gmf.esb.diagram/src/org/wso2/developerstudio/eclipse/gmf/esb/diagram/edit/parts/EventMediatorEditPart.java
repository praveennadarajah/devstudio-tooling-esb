...
public class EventMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EventMediatorFigure(new Color(null, 121, 86, 73)) {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventMediatorTopicTypeEditPart) {
			((EventMediatorTopicTypeEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureEventMediatorPropertyValue());
			return true;
		}
		if (childEditPart instanceof EventMediatorDescriptionEditPart) {
			((EventMediatorDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getEventMediatorDescriptionLabel());
			return true;
		}
	...
	public class EventMediatorFigure extends EsbGraphicalShapeWithLabel {
		 ...
		 * @generated
		 */
		public EventMediatorFigure(Color borderColor) {
		...
		private void createContents() {
			...
			fFigureEventMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
		...
		public String getIconPath() {
			return EVENT_MEDIATOR_ICON_PATH;
		}
		...
		public IFigure getToolTip() {
			if (StringUtils.isEmpty(toolTipMessage)) {
				toolTipMessage = Messages.EventMediatorEditPart_ToolTipMessage;
			}
