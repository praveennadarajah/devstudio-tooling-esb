 ...
 * @generated
 */
public class SwitchDefaultParentContainerItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SwitchDefaultParentContainerItemSemanticEditPolicy() {
		super(EsbElementTypes.SwitchDefaultParentContainer_3734);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.SwitchDefaultContainer_3735 == req.getElementType()) {
